...
- `scripts/`: Repo tooling run by hand or by a spec — the v4 audits (`gpu-jsdoc-coverage.mjs`, `gpu-throw-coverage.mjs`), the CSS type generator, and the benchmark downloader.
