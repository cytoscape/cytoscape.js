...
node pair, so every endpoint move re-fans a whole bundle.
  ...
  node --import tsx benchmark/gpu/curves.mjs              # 20k nodes
  BENCH_N=100000 node --import tsx benchmark/gpu/curves.mjs
  BENCH_BUNDLE=1 node --import tsx benchmark/gpu/curves.mjs   # no parallelism
*/
...
const build = curveStyle => cytoscapeGpu( {
  elements: elements(),
