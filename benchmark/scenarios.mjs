...
//
//   BENCH_N=200000 BENCH_OP=explore node --import tsx benchmark/scenarios.mjs
//
...
scenario(
  `scn: drag (select band of ${DRAG_BAND} + 8-step shift, position listener)`,
  (cy) => {
...
scenario(
  `scn: edit (remove + re-add ${EDIT_BAND} nodes + cascade, add/remove listeners)`,
  (cy) => {
