...
}if(e&&e.type){this.originalEvent=e;this.type=e.type;this.isDefaultPrevented=(e.defaultPrevented||e.getPreventDefault&&e.getPreventDefault())?c:b}else{this.type=e}if(d){a.util.extend(this,d)}this.timeStamp=e&&e.timeStamp||+new Date};function b(){return false}function c(){return true}a.Event.prototype={preventDefault:function(){this.isDefaultPrevented=c;var d=this.originalEvent;if(!d){return}if(d.preventDefault){d.preventDefault()}},stopPropagation:function(){this.isPropagationStopped=c;var d=this.originalEvent;
if(!d){return}if(d.stopPropagation){d.stopPropagation()}},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=c;this.stopPropagation()},isDefaultPrevented:b,isPropagationStopped:b,isImmediatePropagationStopped:b}})(cytoscape);(function(a){a.define={data:function(c){var b={field:"data",bindingEvent:"data",allowBinding:false,allowSetting:false,allowGetting:false,settingEvent:"data",settingTriggersEvent:false,triggerFnName:"trigger",immutableKeys:{},updateMappers:false};c=a.util.extend({},b,c);
return function(e,s){var g=c;var z=this;var f=z.length!==undefined;var t=f?z:[z];var w=f?z[0]:z;if(a.is.string(e)){if(g.allowGetting&&s===undefined){var q;if(w){q=w._private[g.field][e]}return q}else{if(g.allowSetting&&s!==undefined){var d=!g.immutableKeys[e];if(d){for(var o=0,h=t.length;o<h;o++){t[o]._private[g.field][e]=s}if(g.updateMappers){z.updateMappers()}if(g.settingTriggersEvent){z[g.triggerFnName](g.settingEvent)}}}}}else{if(g.allowSetting&&a.is.plainObject(e)){var m=e;var j,u;for(j in m){u=m[j];
var d=!g.immutableKeys[j];if(d){for(var o=0,h=t.length;o<h;o++){t[o]._private[g.field][j]=u}}}if(g.updateMappers){z.updateMappers()}if(g.settingTriggersEvent){z[g.triggerFnName](g.settingEvent)}}else{if(g.allowBinding&&a.is.fn(e)){var r=e;z.bind(g.bindingEvent,r)}else{if(g.allowGetting&&e===undefined){var q;if(w){q=w._private[g.field]}return q}}}}return z}},batchData:function(d){var c={field:"data",event:"data",triggerFnName:"trigger",immutableKeys:{},updateMappers:false};var b=d=a.util.extend({},c,d);
...
D++){var s=m[D];if(a.is.emptyString(s)){continue}var o=s.match(a.define.event.optionalTypeRegex);if(o){var g=o[1]?o[1]:undefined;var r=o[2]?o[2]:undefined;for(var C=0;C<f.length;C++){var v=f[C]._private.listeners;for(var A=0;A<v.length;A++){var k=v[A];var q=!r||r===k.namespace;var w=!g||k.type===g;var z=!l||l===k.callback;var G=q&&w&&z;if(G){v.splice(A,1);A--}}}}}}return t}},trigger:function(c){var b={};c=a.util.extend({},b,c);return function(F,g,A){var q=this;var w=q.length!==undefined;var B=w?q:[q];
var G=w?q[0]:q;var L=a.is.string(F);var h=a.is.plainObject(F);var f=a.is.event(F);var T=c;var C=this._private.cy||this;if(L){var N=F.split(/\s+/);F=[];for(var Z=0;Z<N.length;Z++){var H=N[Z];if(a.is.emptyString(H)){continue}var o=H.match(a.define.event.regex);var ae=o[1];var O=o[2]?o[2]:undefined;F.push({type:ae,namespace:O})}}else{if(h){var ab=F;F=[ab]}}if(g){if(!a.is.array(g)){g=[g]}}else{g=[]}for(var Z=0;Z<F.length;Z++){var r=F[Z];for(var Y=0;Y<B.length;Y++){var M=B[Y];var R=M._private.listeners;
var d=a.is.element(M);var E=d;var H;if(f){H=r;H.cyTarget=H.cyTarget||M;H.cy=H.cy||C;H.namespace=H.namespace||r.namespace}else{H=new a.Event(r,{cyTarget:M,cy:C,namespace:r.namespace})}if(H.cyPosition){var J=H.cyPosition;var W=C.zoom();var s=C.pan();H.cyRenderedPosition={x:J.x*W+s.x,y:J.y*W+s.y}}if(A){R=[{namespace:H.namespace,type:H.type,callback:A}]}for(var X=0;X<R.length;X++){var e=R[X];var P=!e.namespace||e.namespace===H.namespace;var z=e.type===H.type;var Q=e.delegated?(M!==H.cyTarget&&a.is.element(H.cyTarget)&&H.cyTarget.is(e.selector)):(true);
var I=P&&z&&Q;if(I){var S=[H];S=S.concat(g);if(e.data){H.data=e.data}else{H.data=undefined}if(e.unbindSelfOnTrigger||e.unbindAllBindersOnTrigger){R.splice(X,1);X--}if(e.unbindAllBindersOnTrigger){var v=e.binders;for(var V=0;V<v.length;V++){var u=v[V];if(!u||u===M){continue}var D=u._private.listeners;for(var U=0;U<D.length;U++){var ac=D[U];if(ac===e){D.splice(U,1);U--}}}}var ad=e.delegated?H.cyTarget:M;var K=e.callback.apply(ad,S);if(K===false||H.isPropagationStopped()){E=false;if(K===false){H.stopPropagation();
H.preventDefault()}}}}if(E){var t=M.parent();var aa=t.length!==0;if(aa){t=t[0];t.trigger(H)}else{C.trigger(H)}}}}return q}}}})(cytoscape);(function(b,c){var a=("ontouchstart" in c)||c.DocumentTouch&&document instanceof DocumentTouch;b.Style=function(d){if(!(this instanceof b.Style)){return new b.Style(d)}if(!b.is.core(d)){b.util.error("A style must have a core reference");return}this._private={cy:d,coreStyle:{}};this.length=0;this.addDefaultStylesheet()};b.style=b.Style;b.styfn=b.Style.prototype;
...
var d=map[k.name];if(d===undefined){d=map[b.util.dash2camel(k.name)]}if(d!==undefined){var f=k.name;var h=d;this[g].properties.push({name:f,value:h})}}}}return this};b.style.applyFromString=function(w,d){var q=""+d;var l;var e;var g;q=q.replace(/[/][*](\s|.)+?[*][/]/g,"");function f(){if(q.length>l.length){q=q.substr(l.length)}else{q=""}}function B(){if(e.length>g.length){e=e.substr(g.length)}else{e=""}}while(true){var t=q.match(/^\s*$/);if(t){break}var o=q.match(/^\s*((?:.|\s)+?)\s*\{((?:.|\s)+?)\}/);
if(!o){b.util.error("Halting stylesheet parsing: String stylesheet contains more to parse but no selector and block found in: "+q);break}l=o[0];var p=o[1];var u=new b.Selector(p);if(u._private.invalid){b.util.error("Skipping parsing of block: Invalid selector found in string stylesheet: "+p);f();continue}var s=o[2];var r=false;e=s;var k=[];while(true){var t=e.match(/^\s*$/);if(t){break}var j=e.match(/^\s*(.+?)\s*:\s*(.+?)\s*;/);if(!j){b.util.error("Skipping parsing of block: Invalid formatting of style property and value definitions found in:"+s);
r=true;break}g=j[0];var A=j[1];var m=j[2];var h=b.style.properties[A];if(!h){b.util.error("Skipping property: Invalid property name in: "+g);B();continue}var z=w.parse(A,m);if(!z){b.util.error("Skipping property: Invalid property definition in: "+g);B();continue}k.push({name:A,val:m});B()}if(r){f();break}w.selector(p);for(var v=0;v<k.length;v++){var h=k[v];w.css(h.name,h.val)}f()}return w};b.style.fromString=function(f,d){var e=new b.Style(f);b.style.applyFromString(e,d);return e};b.styfn.fromString=function(d){var e=this;
e.resetToDefault();b.style.applyFromString(e,d);return e};b.style.applyFromJson=function(k,h){for(var g=0;g<h.length;g++){var f=h[g];var d=f.selector;var j=f.css;k.selector(d);for(var e in j){var l=j[e];k.css(e,l)}}return k};b.style.fromJson=function(f,d){var e=new b.Style(f);b.style.applyFromJson(e,d);return e};b.styfn.fromJson=function(d){var e=this;e.resetToDefault();b.style.applyFromJson(e,d);return e};b.styfn.json=function(){var k=[];for(var h=0;h<this.length;h++){var e=this[h];var d=e.selector;
var l=e.properties;var g={};for(var f=0;f<l.length;f++){var m=l[f];g[m.name]=m.strValue}k.push({selector:!d?"core":d.toString(),css:g})}return k};b.Stylesheet.prototype.generateStyle=function(m){var k=new b.Style(m);for(var g=0;g<this.length;g++){var f=this[g];var d=f.selector;var h=f.properties;k.selector(d);for(var e=0;e<h.length;e++){var l=h[e];k.css(l.name,l.value)}}return k};b.Stylesheet.prototype.assignToStyle=function(l,e){l.clear();if(e||e===undefined){l.addDefaultStylesheet()}for(var h=0;
h<this.length;h++){var g=this[h];var d=g.selector;var k=g.properties;l.selector(d);for(var f=0;f<k.length;f++){var m=k[f];l.css(m.name,m.value)}}};(function(){var f=b.util.regex.number;var g=b.util.regex.rgbaNoBackRefs;var e=b.util.regex.hslaNoBackRefs;var m=b.util.regex.hex3;var l=b.util.regex.hex6;var j=function(q){return"^"+q+"\\s*\\(\\s*([\\w\\.]+)\\s*\\)$"};var o=function(q){return"^"+q+"\\s*\\(([\\w\\.]+)\\s*\\,\\s*("+f+")\\s*\\,\\s*("+f+")\\s*,\\s*("+f+"|\\w+|"+g+"|"+e+"|"+m+"|"+l+")\\s*\\,\\s*("+f+"|\\w+|"+g+"|"+e+"|"+m+"|"+l+")\\)$"
};b.style.types={percent:{number:true,min:0,max:100,units:"%"},zeroOneNumber:{number:true,min:0,max:1,unitless:true},nonNegativeInt:{number:true,min:0,integer:true,unitless:true},size:{number:true,min:0,enums:["auto"]},bgSize:{number:true,min:0,allowPercent:true},color:{color:true},lineStyle:{enums:["solid","dotted","dashed"]},curveStyle:{enums:["bundled","bezier"]},fontFamily:{regex:"^([\\w- ]+(?:\\s*,\\s*[\\w- ]+)*)$"},fontVariant:{enums:["small-caps","normal"]},fontStyle:{enums:["italic","normal","oblique"]},fontWeight:{enums:["normal","bold","bolder","lighter","100","200","300","400","500","600","800","900",100,200,300,400,500,600,700,800,900]},textDecoration:{enums:["none","underline","overline","line-through"]},textTransform:{enums:["none","capitalize","uppercase","lowercase"]},nodeShape:{enums:["rectangle","roundrectangle","ellipse","triangle","square","pentagon","hexagon","heptagon","octagon"]},arrowShape:{enums:["tee","triangle","square","circle","diamond","none"]},display:{enums:["element","none"]},visibility:{enums:["hidden","visible"]},valign:{enums:["top","center","bottom"]},halign:{enums:["left","center","right"]},positionx:{enums:["left","center","right"],number:true,allowPercent:true},positiony:{enums:["top","center","bottom"],number:true,allowPercent:true},bgRepeat:{enums:["repeat","repeat-x","repeat-y","no-repeat"]},cursor:{enums:["auto","crosshair","default","e-resize","n-resize","ne-resize","nw-resize","pointer","progress","s-resize","sw-resize","text","w-resize","wait","grab","grabbing"]},text:{string:true},data:{mapping:true,regex:j("data")},layoutData:{mapping:true,regex:j("layoutData")},mapData:{mapping:true,regex:o("mapData")},mapLayoutData:{mapping:true,regex:o("mapLayoutData")},url:{regex:"^url\\s*\\(\\s*([^\\s]+)\\s*\\s*\\)|none|(.+)$"}};
var p=b.style.types;b.style.properties=[{name:"cursor",type:p.cursor},{name:"text-valign",type:p.valign},{name:"text-halign",type:p.halign},{name:"color",type:p.color},{name:"content",type:p.text},{name:"text-outline-color",type:p.color},{name:"text-outline-width",type:p.size},{name:"text-outline-opacity",type:p.zeroOneNumber},{name:"text-opacity",type:p.zeroOneNumber},{name:"text-decoration",type:p.textDecoration},{name:"text-transform",type:p.textTransform},{name:"font-family",type:p.fontFamily},{name:"font-style",type:p.fontStyle},{name:"font-variant",type:p.fontVariant},{name:"font-weight",type:p.fontWeight},{name:"font-size",type:p.size},{name:"min-zoomed-font-size",type:p.size},{name:"display",type:p.display},{name:"visibility",type:p.visibility},{name:"opacity",type:p.zeroOneNumber},{name:"z-index",type:p.nonNegativeInt},{name:"overlay-padding",type:p.size},{name:"overlay-color",type:p.color},{name:"overlay-opacity",type:p.zeroOneNumber},{name:"background-color",type:p.color},{name:"background-opacity",type:p.zeroOneNumber},{name:"background-image",type:p.url},{name:"background-position-x",type:p.positionx},{name:"background-position-y",type:p.positiony},{name:"background-repeat",type:p.bgRepeat},{name:"background-size-x",type:p.bgSize},{name:"background-size-y",type:p.bgSize},{name:"pie-1-background-color",type:p.color},{name:"pie-2-background-color",type:p.color},{name:"pie-3-background-color",type:p.color},{name:"pie-4-background-color",type:p.color},{name:"pie-5-background-color",type:p.color},{name:"pie-6-background-color",type:p.color},{name:"pie-7-background-color",type:p.color},{name:"pie-8-background-color",type:p.color},{name:"pie-9-background-color",type:p.color},{name:"pie-10-background-color",type:p.color},{name:"pie-11-background-color",type:p.color},{name:"pie-12-background-color",type:p.color},{name:"pie-13-background-color",type:p.color},{name:"pie-14-background-color",type:p.color},{name:"pie-15-background-color",type:p.color},{name:"pie-16-background-color",type:p.color},{name:"pie-1-background-size",type:p.percent},{name:"pie-2-background-size",type:p.percent},{name:"pie-3-background-size",type:p.percent},{name:"pie-4-background-size",type:p.percent},{name:"pie-5-background-size",type:p.percent},{name:"pie-6-background-size",type:p.percent},{name:"pie-7-background-size",type:p.percent},{name:"pie-8-background-size",type:p.percent},{name:"pie-9-background-size",type:p.percent},{name:"pie-10-background-size",type:p.percent},{name:"pie-11-background-size",type:p.percent},{name:"pie-12-background-size",type:p.percent},{name:"pie-13-background-size",type:p.percent},{name:"pie-14-background-size",type:p.percent},{name:"pie-15-background-size",type:p.percent},{name:"pie-16-background-size",type:p.percent},{name:"border-color",type:p.color},{name:"border-opacity",type:p.zeroOneNumber},{name:"border-width",type:p.size},{name:"border-style",type:p.lineStyle},{name:"height",type:p.size},{name:"width",type:p.size},{name:"padding-left",type:p.size},{name:"padding-right",type:p.size},{name:"padding-top",type:p.size},{name:"padding-bottom",type:p.size},{name:"shape",type:p.nodeShape},{name:"source-arrow-shape",type:p.arrowShape},{name:"target-arrow-shape",type:p.arrowShape},{name:"source-arrow-color",type:p.color},{name:"target-arrow-color",type:p.color},{name:"line-style",type:p.lineStyle},{name:"line-color",type:p.color},{name:"control-point-step-size",type:p.size},{name:"curve-style",type:p.curveStyle},{name:"selection-box-color",type:p.color},{name:"selection-box-opacity",type:p.zeroOneNumber},{name:"selection-box-border-color",type:p.color},{name:"selection-box-border-width",type:p.size},{name:"panning-cursor",type:p.cursor},{name:"active-bg-color",type:p.color},{name:"active-bg-opacity",type:p.zeroOneNumber},{name:"active-bg-size",type:p.size}];
var k=b.style.properties;for(var h=0;h<k.length;h++){var d=k[h];k[d.name]=d}b.style.pieBackgroundN=16})();b.styfn.addDefaultStylesheet=function(){var d="Helvetica"||this.containerPropertyAsString("font-family")||"sans-serif";var k="normal"||this.containerPropertyAsString("font-style")||"normal";var g="normal"||this.containerPropertyAsString("font-variant")||"normal";var f="normal"||this.containerPropertyAsString("font-weight")||"normal";var e="#000"||this.containerPropertyAsString("color")||"#000";
var l="none"||this.containerPropertyAsString("text-transform")||"none";var j="none"||this.containerPropertyAsString("text-decoration")||"none";var h=16||this.containerPropertyAsString("font-size")||16;this.selector("node, edge").css({cursor:"default","text-valign":"top","text-halign":"center",color:e,content:undefined,"text-outline-color":"#000","text-outline-width":0,"text-outline-opacity":1,"text-opacity":1,"text-decoration":"none","text-transform":l,"font-family":d,"font-style":k,"font-variant":g,"font-weight":f,"font-size":h,"min-zoomed-font-size":0,visibility:"visible",display:"element",opacity:1,"z-index":0,content:"","overlay-opacity":0,"overlay-color":"#000","overlay-padding":10,"background-color":"#888","background-opacity":1,"background-image":"none","border-color":"#000","border-opacity":1,"border-width":0,"border-style":"solid",height:30,width:30,"padding-top":0,"padding-bottom":0,"padding-left":0,"padding-right":0,shape:"ellipse","pie-1-background-color":"black","pie-1-background-size":"0%","pie-2-background-color":"black","pie-2-background-size":"0%","pie-3-background-color":"black","pie-3-background-size":"0%","pie-4-background-color":"black","pie-4-background-size":"0%","pie-5-background-color":"black","pie-5-background-size":"0%","pie-6-background-color":"black","pie-6-background-size":"0%","pie-7-background-color":"black","pie-7-background-size":"0%","pie-8-background-color":"black","pie-8-background-size":"0%","pie-9-background-color":"black","pie-9-background-size":"0%","pie-10-background-color":"black","pie-10-background-size":"0%","pie-11-background-color":"black","pie-11-background-size":"0%","pie-12-background-color":"black","pie-12-background-size":"0%","pie-13-background-color":"black","pie-13-background-size":"0%","pie-14-background-color":"black","pie-14-background-size":"0%","pie-15-background-color":"black","pie-15-background-size":"0%","pie-16-background-color":"black","pie-16-background-size":"0%","source-arrow-shape":"none","target-arrow-shape":"none","source-arrow-color":"#bbb","target-arrow-color":"#bbb","line-style":"solid","line-color":"#bbb","control-point-step-size":40,"curve-style":"bezier"}).selector("$node > node").css({width:"auto",height:"auto",shape:"rectangle","background-opacity":0.5,"padding-top":10,"padding-right":10,"padding-left":10,"padding-bottom":10}).selector("edge").css({width:1,}).selector(":active").css({"overlay-color":"black","overlay-padding":10,"overlay-opacity":0.25}).selector("core").css({"selection-box-color":"#ddd","selection-box-opacity":0.65,"selection-box-border-color":"#aaa","selection-box-border-width":1,"panning-cursor":"grabbing","active-bg-color":"black","active-bg-opacity":0.15,"active-bg-size":a?40:15})
};b.styfn.clear=function(){this._private.newStyle=true;for(var d=0;d<this.length;d++){delete this[d]}this.length=0;return this};b.styfn.resetToDefault=function(){this.clear();this.addDefaultStylesheet();return this};b.styfn.core=function(){return this._private.coreStyle};b.styfn.parse=function(I,z,p){I=b.util.camel2dash(I);var j=b.style.properties[I];var r=z;if(!j){return null}if(z===undefined||z===null){return null}var k=b.is.string(z);if(k){z=b.util.trim(z)}var h=j.type;if(!h){return null}if(p&&(z===""||z===null)){return{name:I,value:z,bypass:true,deleteBypass:true}
}var H,t,D,A;if(!k){}else{if((H=new RegExp(b.style.types.data.regex).exec(z))||(D=new RegExp(b.style.types.layoutData.regex).exec(z))){var l=D!==undefined;H=H||D;return{name:I,value:H,strValue:z,mapped:l?b.style.types.layoutData:b.style.types.data,field:H[1],bypass:p}}else{if((t=new RegExp(b.style.types.mapData.regex).exec(z))||(A=new RegExp(b.style.types.mapLayoutData.regex).exec(z))){var l=A!==undefined;t=t||A;if(!(h.color||h.number)){return false}var e=this.parse(I,t[4]);if(!e||e.mapped){return false
}var g=this.parse(I,t[5]);if(!g||g.mapped){return false}if(e.value===g.value){return false}else{if(h.color){var v=e.value;var u=g.value;var C=v[0]===u[0]&&v[1]===u[1]&&v[2]===u[2]&&(v[3]===u[3]||((v[3]==null||v[3]===1)&&(u[3]==null||u[3]===1)));if(C){return false}}}return{name:I,value:t,strValue:z,mapped:l?b.style.types.mapLayoutData:b.style.types.mapData,field:t[1],fieldMin:parseFloat(t[2]),fieldMax:parseFloat(t[3]),valueMin:e.value,valueMax:g.value,bypass:p}}}}if(h.number){var B;var q="px";if(h.units){B=h.units
}if(!h.unitless){if(k){var F="px|em"+(h.allowPercent?"|\\%":"");if(B){F=B}var o=z.match("^("+b.util.regex.number+")("+F+")?$");if(o){z=o[1];B=o[2]||q}}else{if(!B){B=q}}}z=parseFloat(z);if(isNaN(z)&&h.enums===undefined){return null}if(isNaN(z)&&h.enums!==undefined){z=r;for(var E=0;E<h.enums.length;E++){var d=h.enums[E];if(d===z){return{name:I,value:z,strValue:z,bypass:p}}}return null}if(h.integer&&!b.is.integer(z)){return null}if((h.min!==undefined&&z<h.min)||(h.max!==undefined&&z>h.max)){return null
}var G={name:I,value:z,strValue:""+z+(B?B:""),units:B,bypass:p,pxValue:h.unitless||B==="%"?undefined:(B==="px"||!B?(z):(this.getEmSizeInPixels()*z))};return G}else{if(h.color){var s=b.util.color2tuple(z);return{name:I,value:s,strValue:z,bypass:p}}else{if(h.enums){for(var E=0;E<h.enums.length;E++){var d=h.enums[E];if(d===z){return{name:I,value:z,strValue:z,bypass:p}}}}else{if(h.regex){var f=new RegExp(h.regex);var w=f.exec(z);if(w){return{name:I,value:w,strValue:z,bypass:p}}else{return null}}else{if(h.string){return{name:I,value:z,strValue:z,bypass:p}
}else{return null}}}}}};b.styfn.getEmSizeInPixels=function(){var g=this._private.cy;var f=g.container();if(c&&f&&c.getComputedStyle){var e=c.getComputedStyle(f).getPropertyValue("font-size");var d=parseFloat(e);return d}else{return 1}};b.styfn.containerCss=function(d){var f=this._private.cy;var e=f.container();if(c&&e&&c.getComputedStyle){return c.getComputedStyle(e).getPropertyValue(d)}};b.styfn.containerProperty=function(e){var d=this.containerCss(e);var f=this.parse(e,d);return f};b.styfn.containerPropertyAsString=function(d){var e=this.containerProperty(d);
if(e){return e.strValue}};b.styfn.selector=function(e){var d=e==="core"?null:new b.Selector(e);var f=this.length++;this[f]={selector:d,properties:[]};return this};b.styfn.css=function(){var e=arguments;switch(e.length){case 1:var g=e[0];for(var f=0;f<b.style.properties.length;f++){var h=b.style.properties[f];var d=g[h.name];if(d===undefined){d=g[b.util.dash2camel(h.name)]}if(d!==undefined){this.cssRule(h.name,d)}}break;case 2:this.cssRule(e[0],e[1]);break;default:break}return this};b.styfn.cssRule=function(d,h){var g=this.parse(d,h);
if(g){var e=this.length-1;this[e].properties.push(g);var f=!this[e].selector;if(f){this._private.coreStyle[g.name]=g}}return this};b.styfn.applyParsedProperty=function(u,F,k){F=b.util.clone(F);var l=F;var D=u._private.style;var r,o;var m=b.style.properties[l.name].type;var t=l.bypass;var E=D[l.name];var z=E&&E.bypass;if((F.name==="height"||F.name==="width")&&F.value==="auto"&&u.isNode()&&!u.isParent()){return false}if(t&&l.deleteBypass){var v=D[l.name];if(!v){return true}else{if(v.bypass&&v.bypassed){D[l.name]=v.bypassed;
return true}else{return false}}}switch(l.mapped){case b.style.types.mapData:case b.style.types.mapLayoutData:var s=l.mapped===b.style.types.mapLayoutData;var w=l.field.split(".");var r=s?u._private.layoutData:u._private.data;for(var C=0;C<w.length&&r;C++){var f=w[C];r=r[f]}if(!b.is.number(r)){return false}var e=(r-l.fieldMin)/(l.fieldMax-l.fieldMin);if(m.color){var B=l.valueMin[0];var A=l.valueMax[0];var d=l.valueMin[1];var I=l.valueMax[1];var q=l.valueMin[2];var p=l.valueMax[2];var H=l.valueMin[3]==null?1:l.valueMin[3];
var G=l.valueMax[3]==null?1:l.valueMax[3];var j=[Math.round(B+(A-B)*e),Math.round(d+(I-d)*e),Math.round(q+(p-q)*e),Math.round(H+(G-H)*e)];o={bypass:l.bypass,name:l.name,value:j,strValue:["rgba(",j[0],", ",j[1],", ",j[2],", ",j[3],")"].join("")}}else{if(m.number){var h=l.valueMin+(l.valueMax-l.valueMin)*e;o=this.parse(l.name,h,l.bypass)}else{return false}}if(!o){o=this.parse(l.name,E.strValue,l.bypass)}o.mapping=l;l=o;break;case b.style.types.data:case b.style.types.layoutData:var s=l.mapped===b.style.types.layoutData;
var w=l.field.split(".");var r=s?u._private.layoutData:u._private.data;for(var C=0;C<w.length&&r;C++){var f=w[C];r=r[f]}o=this.parse(l.name,r,l.bypass);if(!o){o=this.parse(l.name,E.strValue,l.bypass)}o.mapping=l;l=o;break;case undefined:break;default:return false}if(t){if(z){l.bypassed=E.bypassed}else{l.bypassed=E}D[l.name]=l}else{var g;if(z){g=E.bypassed;E.bypassed=l}else{g=D[l.name];D[l.name]=l}if(g&&g.mapping&&l.mapping&&g.context===k){g=g.prev}if(g&&g!==l){l.prev=g}}l.context=k;return true};b.styfn.rollBackContext=function(p,e){for(var h=0;
h<e.properties.length;h++){var d=e.properties[h];var m=p._private.style[d.name];if(m.bypassed){m=m.bypassed}var k=true;var o;var g=0;while(m.prev){var f=m.prev;if(m.context===e){if(k){p._private.style[d.name]=f}else{if(o){o.prev=f}}}o=m;m=f;k=false;g++}}};b.styfn.apply=function(p){var m=this;for(var e=0;e<p.length;e++){var o=p[e];if(m._private.newStyle){o._private.styleCxts=[];o._private.style={}}for(var h=0;h<this.length;h++){var f=this[h];var k=f.selector&&f.selector.filter(o).length>0;var l=f.properties;
if(k){for(var g=0;g<l.length;g++){var d=l[g];if(!o._private.styleCxts[h]||d.mapped){this.applyParsedProperty(o,d,f)}}o._private.styleCxts[h]=f}else{if(o._private.styleCxts[h]){this.rollBackContext(o,f)}delete o._private.styleCxts[h]}}}m._private.newStyle=false};b.styfn.update=function(){var e=this._private.cy;var d=e.elements();d.updateStyle()};b.styfn.getRenderedStyle=function(m){var m=m[0];if(m){var d={};var f=m._private.style;var j=this._private.cy;var l=j.zoom();for(var k=0;k<b.style.properties.length;
k++){var e=b.style.properties[k];var h=f[e.name];if(h){var g=h.unitless?h.strValue:(h.pxValue*l)+"px";d[e.name]=g;d[b.util.dash2camel(e.name)]=g}}return d}};b.styfn.getRawStyle=function(h){var h=h[0];if(h){var e={};var g=h._private.style;for(var f=0;f<b.style.properties.length;f++){var j=b.style.properties[f];var d=g[j.name];if(d){e[j.name]=d.strValue;e[b.util.dash2camel(j.name)]=d.strValue}}return e}};b.styfn.getValueStyle=function(h){var e,g;if(b.is.element(h)){e={};g=h._private.style}else{e={};
g=h}if(g){for(var f=0;f<b.style.properties.length;f++){var k=b.style.properties[f];var d=g[k.name]||g[b.util.dash2camel(k.name)];if(d!==undefined&&!b.is.plainObject(d)){d=this.parse(k.name,d)}if(d){var j=d.value===undefined?d:d.value;e[k.name]=j;e[b.util.dash2camel(k.name)]=j}}}return e};b.styfn.updateMappers=function(d){for(var g=0;g<d.length;g++){var l=d[g];var k=l._private.style;for(var f=0;f<b.style.properties.length;f++){var m=b.style.properties[f];var h=k[m.name];if(h&&h.mapping){var e=h.mapping;
this.applyParsedProperty(l,e)}}}};b.styfn.applyBypass=function(q,e,o){var m=[];if(e==="*"||e==="**"){if(o!==undefined){for(var h=0;h<b.style.properties.length;h++){var d=b.style.properties[h];var e=d.name;var l=this.parse(e,o,true);if(l){m.push(l)}}}}else{if(b.is.string(e)){var l=this.parse(e,o,true);if(l){m.push(l)}}else{if(b.is.plainObject(e)){var f=e;for(var h=0;h<b.style.properties.length;h++){var d=b.style.properties[h];var e=d.name;var o=f[e];if(o===undefined){o=f[b.util.dash2camel(e)]}if(o!==undefined){var l=this.parse(e,o,true);
if(l){m.push(l)}}}}else{return false}}}if(m.length===0){return false}var k=false;for(var h=0;h<q.length;h++){var p=q[h];for(var g=0;g<m.length;g++){var d=m[g];k=this.applyParsedProperty(p,d)||k}}return k};b.styfn.removeAllBypasses=function(d){for(var h=0;h<b.style.properties.length;h++){var m=b.style.properties[h];var g=m.name;var l="";var e=this.parse(g,l,true);for(var f=0;f<d.length;f++){var k=d[f];this.applyParsedProperty(k,e)}}}})(cytoscape,typeof window==="undefined"?null:window);(function(b){var a=window&&("ontouchstart" in window)||window.DocumentTouch&&document instanceof DocumentTouch;
var d={hideEdgesOnViewport:false};var c=b.util.copy(d);b.defaults=function(e){d=b.util.extend({},c,e)};b.fn.core=function(e,g){for(var f in e){var h=e[f];b.Core.prototype[f]=h}};b.Core=function(l){if(!(this instanceof b.Core)){return new b.Core(l)}var m=this;l=b.util.extend({},d,l);var f=l.container;var h=b.getRegistrationForInstance(m,f);if(h&&h.cy){h.domElement.innerHTML="";h.cy.notify({type:"destroy"});b.removeRegistrationForInstance(h.cy,h.domElement)}h=b.registerInstance(m,f);var k=h.readies;
var g=l;g.layout=b.util.extend({name:typeof window==="undefined"?"null":"grid"},g.layout);g.renderer=b.util.extend({name:typeof window==="undefined"?"null":"canvas"},g.renderer);var e=this._private={ready:false,initrender:false,instanceId:h.id,options:g,elements:[],id2index:{},listeners:[],aniEles:[],scratch:{},layout:null,renderer:null,notificationsEnabled:true,minZoom:1e-50,maxZoom:1e+50,zoomingEnabled:g.zoomingEnabled===undefined?true:g.zoomingEnabled,userZoomingEnabled:g.userZoomingEnabled===undefined?true:g.userZoomingEnabled,panningEnabled:g.panningEnabled===undefined?true:g.panningEnabled,userPanningEnabled:g.userPanningEnabled===undefined?true:g.userPanningEnabled,boxSelectionEnabled:g.boxSelectionEnabled===undefined?true:g.boxSelectionEnabled,zoom:b.is.number(g.zoom)?g.zoom:1,pan:{x:b.is.plainObject(g.pan)&&b.is.number(g.pan.x)?g.pan.x:0,y:b.is.plainObject(g.pan)&&b.is.number(g.pan.y)?g.pan.y:0,},hasCompoundNodes:false};
var j=g.selectionType;if(j===undefined||(j!=="additive"&&j!=="single")){if(a){e.selectionType="additive"}else{e.selectionType="single"}}else{e.selectionType=j}if(b.is.number(g.minZoom)&&b.is.number(g.maxZoom)&&g.minZoom<g.maxZoom){e.minZoom=g.minZoom;e.maxZoom=g.maxZoom}else{if(b.is.number(g.minZoom)&&g.maxZoom===undefined){e.minZoom=g.minZoom}else{if(b.is.number(g.maxZoom)&&g.minZoom===undefined){e.maxZoom=g.maxZoom}}}if(b.is.stylesheet(g.style)){e.style=g.style.generateStyle(this)}else{if(b.is.array(g.style)){e.style=b.style.fromJson(this,g.style)
}else{if(b.is.string(g.style)){e.style=b.style.fromString(this,g.style)}else{e.style=new b.Style(m)}}}m.initRenderer(b.util.extend({hideEdgesOnViewport:g.hideEdgesOnViewport},g.renderer));if(g.initrender){m.on("initrender",g.initrender);m.on("initrender",function(){m._private.initrender=true})}m.load(g.elements,function(){m.startAnimationLoop();m._private.ready=true;if(b.is.fn(g.ready)){m.bind("ready",g.ready)}for(var o=0;o<k.length;o++){var p=k[o];m.bind("ready",p)}h.readies=[];m.trigger("ready")
},g.done)};b.corefn=b.Core.prototype;b.fn.core({ready:function(){return this._private.ready},initrender:function(){return this._private.initrender},registered:function(){if(this._private&&this._private.instanceId!=null){return true}else{return false}},registeredId:function(){return this._private.instanceId},getElementById:function(f){var e=this._private.id2index[f];if(e!==undefined){return this._private.elements[e]}return new b.Collection(this)},selectionType:function(){return this._private.selectionType
},hasCompoundNodes:function(){return this._private.hasCompoundNodes},addToPool:function(f){var k=this._private.elements;var m=this._private.id2index;for(var h=0;h<f.length;h++){var j=f[h];var l=j._private.data.id;var g=m[l];var e=g!==undefined;if(!e){g=k.length;k.push(j);m[l]=g;j._private.index=g}}return this},removeFromPool:function(q){var e=this._private.elements;var h=this._private.id2index;for(var l=0;l<q.length;l++){var p=q[l];var f=p._private.data.id;var m=h[f];var o=m!==undefined;if(o){delete this._private.id2index[f];
e.splice(m,1);for(var k=m;k<e.length;k++){var g=e[k]._private.data.id;h[g]--}}}},container:function(){return this._private.options.container},options:function(){return b.util.copy(this._private.options)},json:function(f){var e={};var g=this;e.elements={};g.elements().each(function(h,j){var k=j.group();if(!e.elements[k]){e.elements[k]=[]}e.elements[k].push(j.json())});e.style=g.style().json();e.scratch=g.scratch();e.zoomingEnabled=g._private.zoomingEnabled;e.userZoomingEnabled=g._private.userZoomingEnabled;
e.panningEnabled=g._private.panningEnabled;e.layout=g._private.options.layout;e.renderer=g._private.options.renderer;e.hideEdgesOnViewport=g._private.options.hideEdgesOnViewport;return e}})})(cytoscape);(function(a,b){a.fn.core({add:function(d){var c;var e=this;if(a.is.elementOrCollection(d)){var u=d;if(u._private.cy===e){c=u.restore()}else{var o=[];for(var h=0;h<u.length;h++){var t=u[h];o.push(t.json())}c=new a.Collection(e,o)}}else{if(a.is.array(d)){var o=d;c=new a.Collection(e,o)}else{if(a.is.plainObject(d)&&(a.is.array(d.nodes)||a.is.array(d.edges))){var l=d;
var o=[];var p=["nodes","edges"];for(var h=0,q=p.length;h<q;h++){var r=p[h];var m=l[r];if(a.is.array(m)){for(var f=0,g=m.length;f<g;f++){var s=m[f];var k=a.util.extend({},s,{group:r});o.push(k)}}}c=new a.Collection(e,o)}else{var s=d;c=(new a.Element(e,s)).collection()}}}return c},remove:function(d){if(a.is.elementOrCollection(d)){d=d}else{if(a.is.string(d)){var c=d;d=this.$(c)}}return d.remove()},load:function(g,h,e){var k=this;var d=k.elements();if(d.length>0){d.remove()}k.notifications(false);var c=[];
if(g!=null){if(a.is.plainObject(g)||a.is.array(g)){k.add(g)}}function j(){k.one("layoutready",function(l){k.notifications(true);k.trigger(l);k.notify({type:"load",collection:k.elements(),style:k._private.style});k.one("load",h);k.trigger("load")}).one("layoutstop",function(){k.one("done",e);k.trigger("done")});k.layout(k._private.options.layout)}if(b){function f(m){var l=(document&&(document.readyState==="interactive"||document.readyState==="complete"))?m:f;setTimeout(l,9,m)}f(j)}else{j()}return this
}})})(cytoscape,typeof window==="undefined"?null:window);(function(a){a.fn.core({addToAnimationPool:function(b){var h=this;var c=h._private.aniEles;var e=[];for(var d=0;d<c.length;d++){var g=c[d]._private.data.id;e[g]=true}for(var d=0;d<b.length;d++){var f=b[d];var g=f._private.data.id;if(!e[g]){c.push(f)}}},startAnimationLoop:function(){var g=this;var f=1000/60;var m=false;var j=true;g._private.aniEles=[];var k=typeof window==="undefined"?function(){}:(window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame);
...
}return b}});a.corefn.elements=a.corefn.filter=a.corefn.$})(cytoscape);(function(a){a.fn.core({style:function(b){return this._private.style}})})(cytoscape);(function(a){a.fn.core({panningEnabled:function(b){if(b!==undefined){this._private.panningEnabled=b?true:false}else{return this._private.panningEnabled}return this},userPanningEnabled:function(b){if(b!==undefined){this._private.userPanningEnabled=b?true:false}else{return this._private.userPanningEnabled}return this},zoomingEnabled:function(b){if(b!==undefined){this._private.zoomingEnabled=b?true:false
}else{return this._private.zoomingEnabled}return this},userZoomingEnabled:function(b){if(b!==undefined){this._private.userZoomingEnabled=b?true:false}else{return this._private.userZoomingEnabled}return this},boxSelectionEnabled:function(b){if(b!==undefined){this._private.boxSelectionEnabled=b?true:false}else{return this._private.boxSelectionEnabled}return this},pan:function(){var c=arguments;var g=this._private.pan;var d,f,e,b,h;switch(c.length){case 0:return g;case 1:if(!this._private.panningEnabled){return this
}else{if(a.is.string(c[0])){d=c[0];return g[d]}else{if(a.is.plainObject(c[0])){e=c[0];b=e.x;h=e.y;if(a.is.number(b)){g.x=b}if(a.is.number(h)){g.y=h}this.trigger("pan")}}}break;case 2:if(!this._private.panningEnabled){return this}d=c[0];f=c[1];if((d==="x"||d==="y")&&a.is.number(f)){g[d]=f}this.trigger("pan");break;default:break}this.notify({type:"viewport"});return this},panBy:function(h){var c=arguments;var g=this._private.pan;var d,f,e,b,j;if(!this._private.panningEnabled){return this}switch(c.length){case 1:if(a.is.plainObject(c[0])){e=c[0];
b=e.x;j=e.y;if(a.is.number(b)){g.x+=b}if(a.is.number(j)){g.y+=j}this.trigger("pan")}break;case 2:d=c[0];f=c[1];if((d==="x"||d==="y")&&a.is.number(f)){g[d]+=f}this.trigger("pan");break;default:break}this.notify({type:"viewport"});return this},fit:function(g,j){if(a.is.number(g)&&j===undefined){j=g;g=undefined}if(!this._private.panningEnabled||!this._private.zoomingEnabled){return this}if(a.is.string(g)){var f=g;g=this.$(f)}else{if(!a.is.elementOrCollection(g)){g=this.elements()}}var k=g.boundingBox();
var d=this.style();var b=parseFloat(d.containerCss("width"));var c=parseFloat(d.containerCss("height"));var e;j=a.is.number(j)?j:0;if(!isNaN(b)&&!isNaN(c)&&g.length>0){e=this._private.zoom=Math.min((b-2*j)/k.w,(c-2*j)/k.h);e=e>this._private.maxZoom?this._private.maxZoom:e;e=e<this._private.minZoom?this._private.minZoom:e;this._private.pan={x:(b-e*(k.x1+k.x2))/2,y:(c-e*(k.y1+k.y2))/2};this.trigger("pan zoom");this.notify({type:"viewport"})}return this},minZoom:function(b){if(b===undefined){return this._private.minZoom
}else{if(a.is.number(b)){this._private.minZoom=b}}return this},maxZoom:function(b){if(b===undefined){return this._private.maxZoom}else{if(a.is.number(b)){this._private.maxZoom=b}}return this},zoom:function(d){var k;var m;if(d===undefined){return this._private.zoom}else{if(a.is.number(d)){m=d}else{if(a.is.plainObject(d)){m=d.level;if(d.position){var b=d.position;var l=this._private.pan;var j=this._private.zoom;k={x:b.x*j+l.x,y:b.y*j+l.y}}else{if(d.renderedPosition){k=d.renderedPosition}}if(k&&!this._private.panningEnabled){return this
}}}}if(!this._private.zoomingEnabled){return this}if(!a.is.number(m)||(k&&(!a.is.number(k.x)||!a.is.number(k.y)))){return this}m=m>this._private.maxZoom?this._private.maxZoom:m;m=m<this._private.minZoom?this._private.minZoom:m;if(k){var g=this._private.pan;var h=this._private.zoom;var f=m;var e={x:-f/h*(k.x-g.x)+k.x,y:-f/h*(k.y-g.y)+k.y};this._private.zoom=m;this._private.pan=e;var c=g.x!==e.x||g.y!==e.y;this.trigger("zoom"+(c?" pan":""))}else{this._private.zoom=m;this.trigger("zoom")}this.notify({type:"viewport"});
return this},boundingBox:function(c){var b=this.$(c);return b.boundingBox()},center:function(g){if(!this._private.panningEnabled||!this._private.zoomingEnabled){return this}if(a.is.string(g)){var b=g;g=cy.elements(b)}else{if(!a.is.elementOrCollection(g)){g=cy.elements()}}var j=g.boundingBox();var e=this.style();var c=parseFloat(e.containerCss("width"));var d=parseFloat(e.containerCss("height"));var f=this._private.zoom;this.pan({x:(c-f*(j.x1+j.x2))/2,y:(d-f*(j.y1+j.y2))/2});this.trigger("pan");this.notify({type:"viewport"});
return this},reset:function(){if(!this._private.panningEnabled||!this._private.zoomingEnabled){return this}this.pan({x:0,y:0});if(this._private.maxZoom>1&&this._private.minZoom<1){this.zoom(1)}this.notify({type:"viewport"});return this}})})(cytoscape);(function(b){b.fn.collection=b.fn.eles=function(c,e){for(var d in c){var f=c[d];b.Collection.prototype[d]=f}};var a={prefix:{nodes:"n",edges:"e"},id:{nodes:0,edges:0},generate:function(h,d,g){var c=b.is.element(d)?d._private:d;var e=c.group;var f=g!=null?g:this.prefix[e]+this.id[e];
if(h.getElementById(f).empty()){this.id[e]++}else{while(!h.getElementById(f).empty()){f=this.prefix[e]+(++this.id[e])}}return f}};b.Element=function(d,f,h){if(!(this instanceof b.Element)){return new b.Element(d,f,h)}var o=this;h=(h===undefined||h?true:false);if(d===undefined||f===undefined||!b.is.core(d)){b.util.error("An element must have a core reference and parameters set");return}if(f.group!=="nodes"&&f.group!=="edges"){b.util.error("An element must be of type `nodes` or `edges`; you specified `"+f.group+"`");
return}this.length=1;this[0]=this;this._private={cy:d,single:true,data:f.data||{},layoutData:{},position:f.position||{},autoWidth:undefined,autoHeight:undefined,listeners:[],group:f.group,style:{},rstyle:{},styleCxts:[],removed:true,selected:f.selected?true:false,selectable:f.selectable===undefined?true:(f.selectable?true:false),locked:f.locked?true:false,grabbed:false,grabbable:f.grabbable===undefined?true:(f.grabbable?true:false),active:false,classes:{},animation:{current:[],queue:[]},rscratch:{},scratch:{},edges:[],children:[]};
if(f.renderedPosition){var p=f.renderedPosition;var j=d.pan();var m=d.zoom();this._private.position={x:(p.x-j.x)/m,y:(p.y-j.y)/m}}if(b.is.string(f.classes)){var e=f.classes.split(/\s+/);for(var g=0,c=e.length;g<c;g++){var k=e[g];if(!k||k===""){continue}o._private.classes[k]=true}}if(f.css){d.style().applyBypass(this,f.css)}if(h===undefined||h){this.restore()}};b.Collection=function(h,c){if(!(this instanceof b.Collection)){return new b.Collection(h,c)}if(h===undefined||!b.is.core(h)){b.util.error("A collection must have a reference to the core");
...
var e=[];for(var c in h.classes){e.push(c)}for(var d=0;d<e.length;d++){var c=e[d];f.classes+=c+(d<e.length-1?" ":"")}return f};b.elesfn.jsons=function(){var e=[];for(var d=0;d<this.length;d++){var f=this[d];var c=f.json();e.push(c)}return e};b.elesfn.restore=function(s){var r=this;var J=[];var f=r.cy();if(s===undefined){s=true}var p=[];var z=[],e=[];var v=0;var d=0;for(var F=0,B=r.length;F<B;F++){var o=r[F];if(o.isNode()){z.push(o);v++}else{e.push(o);d++}}p=z.concat(e);for(var F=0,B=p.length;F<B;
F++){var o=p[F];if(!o.removed()){continue}var q=o._private;var K=q.data;if(K.id===undefined){K.id=a.generate(f,o)}else{if(b.is.emptyString(K.id)||!b.is.string(K.id)){continue}else{if(f.getElementById(K.id).length!=0){continue}}}var t=K.id;if(o.isEdge()){var h=o;var u=["source","target"];var w=u.length;for(var C=0;C<w;C++){var c=u[C];var L=K[c];if(L==null||L===""){continue}else{if(f.getElementById(L).empty()){continue}}}var k=f.getElementById(K.source);var E=f.getElementById(K.target);k._private.edges.push(h);
E._private.edges.push(h)}q.ids={};q.ids[K.id]=o;q.removed=false;f.addToPool(o);J.push(o)}for(var F=0;F<v;F++){var A=p[F];var K=A._private.data;var t=K.id;var D=A._private.data.parent;var g=D!=null;if(g){var m=f.getElementById(D);if(m.empty()){delete K.parent}else{var G=false;var I=m;while(!I.empty()){if(A.same(I)){G=true;delete K.parent;break}I=I.parent()}if(!G){m[0]._private.children.push(A);f._private.hasCompoundNodes=true}}}}J=new b.Collection(f,J);if(J.length>0){var H=J.add(J.connectedNodes()).add(J.parent());
H.updateStyle(s);if(s){J.rtrigger("add")}else{J.trigger("add")}}return r};b.elesfn.removed=function(){var c=this[0];return c&&c._private.removed};b.elesfn.inside=function(){var c=this[0];return c&&!c._private.removed};b.elesfn.remove=function(r){var q=this;var A=[];var C=[];var f={};var c=q._private.cy;if(r===undefined){r=true}function B(E){var l=E._private.edges;for(var D=0;D<l.length;D++){m(l[D])}}function j(E){var D=E._private.children;for(var l=0;l<D.length;l++){m(D[l])}}function m(l){var D=f[l.id()];
if(D){return}else{f[l.id()]=true}if(l.isNode()){C.push(l);B(l);j(l)}else{C.unshift(l)}}for(var w=0,s=q.length;w<s;w++){var k=q[w];m(k)}function o(G,F){var l=G._private.edges;for(var D=0;D<l.length;D++){var E=l[D];if(F===E){l.splice(D,1);break}}}function d(E,F){F=F[0];E=E[0];var D=E._private.children;for(var l=0;l<D.length;l++){if(D[l][0]===F[0]){D.splice(l,1);break}}}for(var w=0;w<C.length;w++){var k=C[w];k._private.removed=true;c.removeFromPool(k);A.push(k);if(k.isEdge()){var g=k.source()[0];var z=k.target()[0];
o(g,k);o(z,k)}else{var h=k.parent();if(h.length!==0){d(h,k)}}}var p=c._private.elements;c._private.hasCompoundNodes=false;for(var w=0;w<p.length;w++){var k=p[w];if(k.isParent()){c._private.hasCompoundNodes=true;break}}var v=new b.Collection(this.cy(),A);if(v.size()>0){if(r){this.cy().notify({type:"remove",collection:v})}v.trigger("remove")}var e={};for(var w=0;w<C.length;w++){var k=C[w];var t=k._private.group==="nodes";var u=k._private.data.parent;if(t&&u!==undefined&&!e[u]){e[u]=true;var h=c.getElementById(u);
if(h&&h.length!==0&&!h._private.removed&&h.children().length===0){h.updateStyle()}}}return this}})(cytoscape);(function(a){a.fn.eles({animated:function(){var b=this[0];if(b){return b._private.animation.current.length>0}},clearQueue:function(){for(var b=0;b<this.length;b++){var c=this[b];c._private.animation.queue=[]}return this},delay:function(c,b){this.animate({delay:c},{duration:c,complete:b});return this},animate:function(k,f){var d=+new Date;var e=this._private.cy;var c=e.style();var b;if(f===undefined){f={}
}if(f.duration===undefined){f.duration=400}switch(f.duration){case"slow":f.duration=600;break;case"fast":f.duration=200;break}if(k==null||(k.position==null&&k.renderedPosition==null&&k.css==null&&k.delay==null)){return this}if(k.css){k.css=c.getValueStyle(k.css)}if(k.renderedPosition){var r=k.renderedPosition;var m=e.pan();var p=e.zoom();k.position={x:(r.x-m.x)/p,y:(r.y-m.y)/p}}for(var j=0;j<this.length;j++){var o=this[j];var l=o._private.position;var h={x:l.x,y:l.y};var g=c.getValueStyle(o);if(o.animated()&&(f.queue===undefined||f.queue)){b=o._private.animation.queue
}else{b=o._private.animation.current}b.push({properties:k,duration:f.duration,params:f,callTime:d,startPosition:h,startStyle:g})}e.addToAnimationPool(this);return this},stop:function(f,h){for(var e=0;e<this.length;e++){var c=this[e];var b=c._private.animation.current;for(var d=0;d<b.length;d++){var g=b[d];if(h){g.duration=0}}if(f){c._private.animation.queue=[]}}this.cy().notify({collection:this,type:"draw"});return this}})})(cytoscape);(function(a){a.fn.eles({addClass:function(g){g=g.split(/\s+/);
var c=this;var k=[];for(var f=0;f<g.length;f++){var b=g[f];if(a.is.emptyString(b)){continue}for(var d=0;d<c.length;d++){var h=c[d];var e=h._private.classes[b];h._private.classes[b]=true;if(!e){k.push(h)}}}if(k.length>0){new a.Collection(this._private.cy,k).updateStyle()}c.trigger("class");return c},hasClass:function(b){var c=this[0];return c!=null&&c._private.classes[b]},toggleClass:function(h,g){var b=h.split(/\s+/);var o=this;var e=[];for(var f=0,k=o.length;f<k;f++){var p=o[f];for(var c=0;c<b.length;
c++){var m=b[c];if(a.is.emptyString(m)){continue}var d=p._private.classes[m];var l=g||(g===undefined&&!d);if(l){p._private.classes[m]=true;if(!d){e.push(p)}}else{p._private.classes[m]=false;if(d){e.push(p)}}}}if(e.length>0){new a.Collection(this._private.cy,e).updateStyle()}o.trigger("class");return o},removeClass:function(g){g=g.split(/\s+/);var c=this;var k=[];for(var f=0;f<c.length;f++){var h=c[f];for(var d=0;d<g.length;d++){var b=g[d];if(!b||b===""){continue}var e=h._private.classes[b];delete h._private.classes[b];
if(e){k.push(h)}}}if(k.length>0){new a.Collection(c._private.cy,k).updateStyle()}c.trigger("class");return c}})})(cytoscape);(function(a){a.fn.eles({allAre:function(b){return this.filter(b).length===this.length},is:function(b){return this.filter(b).length>0},same:function(b){b=this.cy().collection(b);if(this.length!==b.length){return false}return this.intersect(b).length===this.length},anySame:function(b){b=this.cy().collection(b);return this.intersect(b).length>0},allAreNeighbors:function(b){b=this.cy().collection(b);
return this.neighborhood().intersect(b).length===b.length}})})(cytoscape);(function(b){var a=1.4;var c=1;b.fn.eles({updateStyle:function(d){var f=this._private.cy;var e=f.style();d=d||d===undefined?true:false;e.apply(this);if(d){this.rtrigger("style")}else{this.trigger("style")}return this},updateMappers:function(d){var f=this._private.cy;var e=f.style();d=d||d===undefined?true:false;e.updateMappers(this);if(d){this.rtrigger("style")}else{this.trigger("style")}return this},data:b.define.data({field:"data",bindingEvent:"data",allowBinding:true,allowSetting:true,settingEvent:"data",settingTriggersEvent:true,triggerFnName:"trigger",allowGetting:true,immutableKeys:{id:true,source:true,target:true,parent:true},updateMappers:true}),removeData:b.define.removeData({field:"data",event:"data",triggerFnName:"trigger",triggerEvent:true,immutableKeys:{id:true,source:true,target:true,parent:true},updateMappers:true}),batchData:b.define.batchData({field:"data",event:"data",triggerFnName:"trigger",immutableKeys:{id:true,source:true,target:true,parent:true},updateMappers:true}),scratch:b.define.data({field:"scratch",allowBinding:false,allowSetting:true,settingTriggersEvent:false,allowGetting:true}),removeScratch:b.define.removeData({field:"scratch",triggerEvent:false}),rscratch:b.define.data({field:"rscratch",allowBinding:false,allowSetting:true,settingTriggersEvent:false,allowGetting:true}),removeRscratch:b.define.removeData({field:"rscratch",triggerEvent:false}),id:function(){var d=this[0];
...
},renderedPosition:function(g,d){var m=this[0];var e=this.cy();var k=e.zoom();var j=e.pan();var l=b.is.plainObject(g)?g:undefined;var o=l!==undefined||(d!==undefined&&b.is.string(g));if(m&&m.isNode()){if(o){for(var f=0;f<this.length;f++){var m=this[f];if(d!==undefined){m._private.position[g]=(d-j[g])/k}else{if(l!==undefined){m._private.position={x:(l.x-j.x)/k,y:(l.y-j.y)/k}}}}this.rtrigger("position")}else{var h=m._private.position;l={x:h.x*k+j.x,y:h.y*k+j.y};if(g===undefined){return l}else{return l[g]
}}}return this},renderedCss:function(f){var e=this[0];if(e){var d=e.cy().style().getRenderedStyle(e);if(f===undefined){return d}else{return d[f]}}},css:function(d,h){var f=this.cy().style();if(b.is.plainObject(d)){var e=d;f.applyBypass(this,e);this.rtrigger("style")}else{if(b.is.string(d)){if(h===undefined){var g=this[0];if(g){return g._private.style[d].strValue}else{return}}else{f.applyBypass(this,d,h);this.rtrigger("style")}}else{if(d===undefined){var g=this[0];if(g){return f.getRawStyle(g)}else{return
}}}}return this},removeCss:function(){var f=this.cy().style();var d=this;for(var e=0;e<d.length;e++){var g=d[e];f.removeAllBypasses(g)}this.rtrigger("style")},show:function(){this.css("display","element");return this},hide:function(){this.css("display","none");return this},visible:function(){var m=this[0];if(m){if(m.css("visibility")!=="visible"||m.css("display")!=="element"){return false}if(m.isNode()){var h=m.parents();for(var g=0;g<h.length;g++){var j=h[g];var k=j.css("visibility");var e=j.css("display");
var l=parseFloat(j.css("opacity"));if(k!=="visible"||e!=="element"){return false}}return true}else{if(m.isEdge()){var d=m.source();var f=m.target();return d.visible()&&f.visible()}}}},hidden:function(){var d=this[0];if(d){return !this.visible()}},transparent:function(){var d=this[0];if(d){return parseFloat(this.css("opacity"))===0}},width:function(){var e=this[0];if(e){var d=this._private.style.width;return d.strValue==="auto"?e._private.autoWidth:d.pxValue}},outerWidth:function(){var g=this[0];if(g){var f=this._private.style;
var e=f.width.strValue==="auto"?g._private.autoWidth:f.width.pxValue;var d=f["border-width"]?f["border-width"].pxValue*a+c:0;return e+d}},renderedWidth:function(){var e=this[0];if(e){var d=this.width();return d*this.cy().zoom()}},renderedOuterWidth:function(){var e=this[0];if(e){var d=this.outerWidth();return d*this.cy().zoom()}},height:function(){var e=this[0];if(e&&e.isNode()){var d=this._private.style.height;return d.strValue==="auto"?e._private.autoHeight:d.pxValue}},outerHeight:function(){var g=this[0];
if(g){var f=this._private.style;var d=f.height.strValue==="auto"?g._private.autoHeight:f.height.pxValue;var e=f["border-width"]?f["border-width"].pxValue*a+c:0;return d+e}},renderedHeight:function(){var e=this[0];if(e){var d=this.height();return d*this.cy().zoom()}},renderedOuterHeight:function(){var e=this[0];if(e){var d=this.outerHeight();return d*this.cy().zoom()}},offset:function(){var g=this[0];if(g&&g.isNode()){var j={x:g._private.position.x,y:g._private.position.y};var d=g.parents();for(var e=0;
e<d.length;e++){var f=d[e];var h=f._private.position;j.x+=h.x;j.y+=h.y}return j}},renderedOffset:function(){var e=this[0];if(e&&e.isNode()){var g=this.offset();var h=this.cy();var d=h.zoom();var f=h.pan();return{x:g.x*d+f.x,y:g.y*d+f.y}}},boundingBox:function(e){var J=this;if(!e||(b.is.elementOrCollection(e)&&e.length===0)){J=this}else{if(b.is.string(e)){J=this.filter(e)}else{if(b.is.elementOrCollection(e)){J=e}}}var p=Infinity;var o=-Infinity;var V=Infinity;var T=-Infinity;for(var R=0;R<J.length;
R++){var U=J[R];var B,A,m,l,G,F;if(U.isNode()){var v=U._private.position;G=v.x;F=v.y;var H=U.outerWidth();var C=H/2;var S=U.outerHeight();var L=S/2;B=G-C;A=G+C;m=F-L;l=F+L;p=B<p?B:p;o=A>o?A:o;V=m<V?m:V;T=l>T?l:T}else{var z=U.source()[0]._private.position;var d=U.target()[0]._private.position;var D=U._private.rstyle;G=D.labelX;F=D.labelY;B=z.x;A=d.x;m=z.y;l=d.y;if(B>A){var f=B;B=A;A=f}if(m>l){var f=m;m=l;l=f}p=B<p?B:p;o=A>o?A:o;V=m<V?m:V;T=l>T?l:T;var k=D.bezierPts||[];var H=U._private.style.width.value;
...
})(cytoscape);(function(c){function a(e){a.CANVAS_LAYERS=5;a.SELECT_BOX=0;a.DRAG=2;a.NODE=4;a.BUFFER_COUNT=2;this.options=e;this.data={select:[undefined,undefined,undefined,undefined,0],renderer:this,cy:e.cy,container:e.cy.container(),canvases:new Array(a.CANVAS_LAYERS),canvasNeedsRedraw:new Array(a.CANVAS_LAYERS),bufferCanvases:new Array(a.BUFFER_COUNT)};this.hoverData={down:null,last:null,downTime:null,triggerMode:null,dragging:false,initialPan:[null,null],capture:false};this.timeoutData={panTimeout:null};
this.dragData={possibleDragElements:[]};this.touchData={start:null,capture:false,startPosition:[null,null,null,null,null,null],singleTouchStartTime:null,singleTouchMoved:true,now:[null,null,null,null,null,null],earlier:[null,null,null,null,null,null]};this.zoomData={freeToZoom:false,lastPointerX:null};this.redraws=0;this.bindings=[];this.data.canvasContainer=document.createElement("div");var g=this.data.canvasContainer.style;g.position="absolute";g.zIndex="0";this.data.container.appendChild(this.data.canvasContainer);
for(var f=0;f<a.CANVAS_LAYERS;f++){this.data.canvases[f]=document.createElement("canvas");this.data.canvases[f].style.position="absolute";this.data.canvases[f].setAttribute("data-id","layer"+f);this.data.canvases[f].style.zIndex=String(a.CANVAS_LAYERS-f);this.data.canvasContainer.appendChild(this.data.canvases[f]);this.data.canvasNeedsRedraw[f]=false}this.data.canvases[a.NODE].setAttribute("data-id","layer"+a.NODE+"-node");this.data.canvases[a.SELECT_BOX].setAttribute("data-id","layer"+a.SELECT_BOX+"-selectbox");
this.data.canvases[a.DRAG].setAttribute("data-id","layer"+a.DRAG+"-drag");for(var f=0;f<a.BUFFER_COUNT;f++){this.data.bufferCanvases[f]=document.createElement("canvas");this.data.bufferCanvases[f].style.position="absolute";this.data.bufferCanvases[f].setAttribute("data-id","buffer"+f);this.data.bufferCanvases[f].style.zIndex=String(-f-1);this.data.bufferCanvases[f].style.visibility="hidden";this.data.canvasContainer.appendChild(this.data.bufferCanvases[f])}this.hideEdgesOnViewport=e.hideEdgesOnViewport;
this.load()}a.panOrBoxSelectDelay=400;a.isTouch=("ontouchstart" in window)||window.DocumentTouch&&document instanceof DocumentTouch;a.prototype.notify=function(e){if(e.type=="destroy"){this.destroy();return}else{if(e.type=="add"||e.type=="remove"||e.type=="load"){this.updateNodesCache();this.updateEdgesCache()}}if(e.type=="viewport"){this.data.canvasNeedsRedraw[a.SELECT_BOX]=true}this.data.canvasNeedsRedraw[a.DRAG]=true;this.data.canvasNeedsRedraw[a.NODE]=true;this.redraw()};a.prototype.destroy=function(){this.destroyed=true;
for(var f=0;f<this.bindings.length;f++){var g=this.bindings[f];var e=g;e.target.removeEventListener(e.event,e.handler,e.useCapture)}};for(var d in c.math){a.prototype[d]=c.math[d]}var b=function(){};c("renderer","canvas",a)})(cytoscape);(function(c){var b=c("renderer","canvas");var a=b.prototype;var d=b.arrowShapes={};d.arrow={_points:[-0.15,-0.3,0,0,0.15,-0.3],collide:function(l,h,g,f,e,o,j,k){var m=d.arrow._points;return c.math.pointInsidePolygon(l,h,m,g,f,e,o,j,k)},roughCollide:function(f,m,l,h,g,e,k,j){if(typeof(d.arrow._farthestPointSqDistance)=="undefined"){d.arrow._farthestPointSqDistance=c.math.findMaxSqDistanceToOrigin(d.arrow._points)
}return c.math.checkInBoundingCircle(f,m,d.arrow._farthestPointSqDistance,0,g,e,l,h)},draw:function(f){var g=d.arrow._points;for(var e=0;e<g.length/2;e++){f.lineTo(g[e*2],g[e*2+1])}},spacing:function(e){return 0},gap:function(e){return e._private.style.width.value*2}};d.triangle=d.arrow;d.none={collide:function(f,m,l,h,g,e,k,j){return false},roughCollide:function(f,m,l,h,g,e,k,j){return false},draw:function(e){},spacing:function(e){return 0},gap:function(e){return 0}};d.circle={_baseRadius:0.15,collide:function(p,l,h,g,e,s,m,o){if(e!=s){var f=Math.asin(m[1]/(Math.sqrt(m[0]*m[0]+m[1]*m[1])));
var r=Math.cos(-f);var k=Math.sin(-f);var j=[p*r-l*k,l*r+p*k];var q=(s+o)/(e+o);l/=q;g/=q;return(Math.pow(h-p,2)+Math.pow(g-l,2)<=Math.pow((e+o)*d.circle._baseRadius,2))}else{return(Math.pow(h-p,2)+Math.pow(g-l,2)<=Math.pow((e+o)*d.circle._baseRadius,2))}},roughCollide:function(f,m,l,h,g,e,k,j){return true},draw:function(e){e.arc(0,0,d.circle._baseRadius,0,Math.PI*2,false)},spacing:function(e){return a.getArrowWidth(e._private.style.width.value)*d.circle._baseRadius},gap:function(e){return e._private.style.width.value*2
}};d.inhibitor={_points:[-0.25,0,-0.25,-0.1,0.25,-0.1,0.25,0],collide:function(l,h,g,f,e,o,j,k){var m=d.inhibitor._points;return c.math.pointInsidePolygon(l,h,m,g,f,e,o,j,k)},roughCollide:function(f,m,l,h,g,e,k,j){if(typeof(d.inhibitor._farthestPointSqDistance)=="undefined"){d.inhibitor._farthestPointSqDistance=c.math.findMaxSqDistanceToOrigin(d.inhibitor._points)}return c.math.checkInBoundingCircle(f,m,d.inhibitor._farthestPointSqDistance,0,g,e,l,h)},draw:function(f){var g=d.inhibitor._points;for(var e=0;
e<g.length/2;e++){f.lineTo(g[e*2],g[e*2+1])}},spacing:function(e){return 4},gap:function(e){return 4}};d.square={_points:[-0.12,0,0.12,0,0.12,-0.24,-0.12,-0.24],collide:function(l,h,g,f,e,o,j,k){var m=d.square._points;return c.math.pointInsidePolygon(l,h,m,g,f,e,o,j,k)},roughCollide:function(f,m,l,h,g,e,k,j){if(typeof(d.square._farthestPointSqDistance)=="undefined"){d.square._farthestPointSqDistance=c.math.findMaxSqDistanceToOrigin(d.square._points)}return c.math.checkInBoundingCircle(f,m,d.square._farthestPointSqDistance,0,g,e,l,h)
},draw:function(f){var g=d.square._points;for(var e=0;e<g.length/2;e++){f.lineTo(g[e*2],g[e*2+1])}},spacing:function(e){return 0},gap:function(e){return e._private.style.width.value*2}};d.diamond={_points:[-0.14,-0.14,0,-0.28,0.14,-0.14,0,0],collide:function(l,h,g,f,e,o,j,k){var m=d.diamond._points;return c.math.pointInsidePolygon(l,h,m,g,f,e,o,j,k)},roughCollide:function(f,m,l,h,g,e,k,j){if(typeof(d.diamond._farthestPointSqDistance)=="undefined"){d.diamond._farthestPointSqDistance=c.math.findMaxSqDistanceToOrigin(d.diamond._points)
...
}})(cytoscape);(function(b){var a=b("renderer","canvas");a.prototype.projectIntoViewport=function(e,c){n=this.data.container;var f=this.findContainerPageCoords();var g=f[0];var d=f[1];x=e-g;y=c-d;x-=this.data.cy.pan().x;y-=this.data.cy.pan().y;x/=this.data.cy.zoom();y/=this.data.cy.zoom();return[x,y]};a.prototype.findContainerPageCoords=function(){var g=0;var f=0;var d=this.data.container;var k=d;while(k!=null){var e=window.getComputedStyle(k);if(typeof(k.offsetLeft)==="number"){var c=e.getPropertyValue("position").toLowerCase();
var h=parseFloat(e.getPropertyValue("border-left-width"));var j=parseFloat(e.getPropertyValue("border-top-width"));g+=k.offsetLeft;f+=k.offsetTop;if(c!=="static"||k===d){g+=h;f+=j}if(c==="fixed"){g+=window.scrollX;f+=window.scrollY;break}if(k==document.body||k==document.header){break}}if(k){k=k.offsetParent}}return[g,f]};a.prototype.findNearestElement=function(t,s,e){var o=this.data;var f=this.getCachedNodes();var l=this.getCachedEdges();var p=[];var k=a.isTouch;var u=this.data.cy.zoom();var h=(k?256:32)/u;
var r=(k?16:0)/u;for(var m=0;m<f.length;m++){if(a.nodeShapes[this.getNodeShape(f[m])].checkPointRough(t,s,f[m]._private.style["border-width"].value/2,this.getNodeWidth(f[m])+r,this.getNodeHeight(f[m])+r,f[m]._private.position.x,f[m]._private.position.y)&&a.nodeShapes[this.getNodeShape(f[m])].checkPoint(t,s,f[m]._private.style["border-width"].value/2,(this.getNodeWidth(f[m])+r),(this.getNodeHeight(f[m])+r),f[m]._private.position.x,f[m]._private.position.y)){if(e){if(f[m]._private.style.opacity.value!=0&&f[m]._private.style.visibility.value=="visible"&&f[m]._private.style.display.value=="element"){p.push(f[m])
...
}}else{if(p=="right"){var l=Math.max(k.x+k.width/2,e.right);if(l>m){m=l}}else{if(p=="top"){var j=Math.min(k.y-k.height/2,e.top);if(j<q){q=j}}else{if(p=="bottom"){var g=Math.max(k.y+k.height/2,e.bottom);if(g>m){m=g}}}}}}if((p=="left")||(p=="top")){return q}else{return m}};a.prototype.getNodeWidth=function(c){if(c._private.style.width.value=="auto"||c._private.style.height.value=="auto"){return c._private.autoWidth}else{return c._private.style.width.pxValue}};a.prototype.getNodeHeight=function(c){if(c._private.style.width.value=="auto"||c._private.style.height.value=="auto"){return c._private.autoHeight
}else{return c._private.style.height.pxValue}};a.prototype.getNodeShape=function(d){var c=d._private.style.shape.value;if(d.isParent()){if(c==="rectangle"||c==="roundrectangle"){return c}else{return"rectangle"}}return c};a.prototype.updateAllCompounds=function(f){for(var c=f.length-1;c>=0;c--){if(f[c].isNode()&&(f[c]._private.style.width.value=="auto"||f[c]._private.style.height.value=="auto")&&f[c].children().length>0){var e=f[c];var d=this.calcCompoundBounds(e);e._private.position.x=d.x;e._private.position.y=d.y;
e._private.autoWidth=d.width;e._private.autoHeight=d.height}}};a.prototype.getNodePadding=function(e){var g=e._private.style["padding-left"].pxValue;var d=e._private.style["padding-right"].pxValue;var f=e._private.style["padding-top"].pxValue;var c=e._private.style["padding-bottom"].pxValue;if(isNaN(g)){g=0}if(isNaN(d)){d=0}if(isNaN(f)){f=0}if(isNaN(c)){c=0}return{left:g,right:d,top:f,bottom:c}};a.prototype.zOrderSort=function(f,e){var d=function(j){if(j._private.group=="nodes"){return j.parents().size()
...
C=Math.acos((q[0]*0+q[1]*-1)/Math.sqrt(q[0]*q[0]+q[1]*q[1]));if(q[0]<0){C=-C+2*Math.PI}}j.translate(u[B*2],u[B*2+1]);j.rotate(C);j.translate(-l/2/g,-r/2/g);j.drawImage(A[0],0,0,l/g,r/g);j.translate(l/2/g,r/2/g);j.rotate(-C);j.translate(-u[B*2],-u[B*2+1])}}else{this.drawStyledEdge(o,j,E,"solid",v)}}}};b.prototype.drawArrowheads=function(g,j,k){if(k){return}var h,f;var m=j._private.rscratch.arrowStartX;var l=j._private.rscratch.arrowStartY;h=m-j.source().position().x;f=l-j.source().position().y;if(!isNaN(m)&&!isNaN(l)&&!isNaN(h)&&!isNaN(f)){g.fillStyle="rgba("+j._private.style["source-arrow-color"].value[0]+","+j._private.style["source-arrow-color"].value[1]+","+j._private.style["source-arrow-color"].value[2]+","+j._private.style.opacity.value+")";
g.lineWidth=j._private.style.width.pxValue;this.drawArrowShape(g,j._private.style["source-arrow-shape"].value,m,l,h,f)}var p=j._private.rscratch.arrowEndX;var o=j._private.rscratch.arrowEndY;h=p-j.target().position().x;f=o-j.target().position().y;if(!isNaN(p)&&!isNaN(o)&&!isNaN(h)&&!isNaN(f)){g.fillStyle="rgba("+j._private.style["target-arrow-color"].value[0]+","+j._private.style["target-arrow-color"].value[1]+","+j._private.style["target-arrow-color"].value[2]+","+j._private.style.opacity.value+")";
g.lineWidth=j._private.style.width.pxValue;this.drawArrowShape(g,j._private.style["target-arrow-shape"].value,p,o,h,f)}};b.prototype.drawArrowShape=function(l,g,f,o,k,h){var m=Math.asin(h/(Math.sqrt(k*k+h*h)));if(k<0){m=m+Math.PI/2}else{m=-(Math.PI/2+m)}l.translate(f,o);l.moveTo(0,0);l.rotate(-m);var j=this.getArrowWidth(l.lineWidth);l.scale(j,j);l.beginPath();b.arrowShapes[g].draw(l);l.closePath();l.fill();l.scale(1/j,1/j);l.rotate(m);l.translate(-f,-o)}})(cytoscape);(function(b){var a=b("renderer","canvas");
var d={};var c=30*300;a.prototype.getCachedImage=function(f,g){if(d[f]&&d[f].image){d[f].keepTime=c;return d[f].image}var e=d[f];if(e==undefined){d[f]=new Object();d[f].image=new Image();d[f].image.onload=g;d[f].image.src=f;d[f].keepTime=c;e=d[f]}return e.image};a.prototype.swapCachedImage=function(f){if(d[f]){if(d[f].image&&d[f].image.complete){var g=d[f].image;var e=document.createElement("canvas");e.width=g.width;e.height=g.height;e.getContext("2d").drawImage(g,0,0);d[f].image=e;d[f].swappedWithCanvas=true;
return e}else{return null}}else{return null}};a.prototype.updateImageCaches=function(){for(var e in d){if(d[e].keepTime<=0){if(d[e].image!=undefined){d[e].image.src=undefined;d[e].image=undefined}d[e]=undefined}else{d[e]-=1}}};a.prototype.drawImage=function(e,m,l,j,h,o,g){g.widthScale=0.5;g.heightScale=0.5;g.rotate=o;var k;var f;canvas.drawImage(g,m,l)};a.prototype.drawInscribedImage=function(g,m,k){var e=this;var p=this.data.cy._private.zoom;var j=k._private.position.x;var h=k._private.position.y;
var o=this.getNodeWidth(k);var f=this.getNodeHeight(k);g.save();a.nodeShapes[e.getNodeShape(k)].drawPath(g,j,h,o,f);g.clip();var l=[m.width,m.height];g.drawImage(m,j-l[0]/2,h-l[1]/2,l[0],l[1]);g.restore();if(k._private.style["border-width"].value>0){g.stroke()}}})(cytoscape);(function(b){var a=b("renderer","canvas");a.prototype.drawEdgeText=function(e,f){if(!f.visible()){return}if(this.hideEdgesOnViewport&&(this.dragData.didDrag||this.pinching||this.hoverData.dragging||this.data.wheel||this.swipePanning)){return
}var h=f._private.style["font-size"].pxValue*f.cy().zoom();var d=f._private.style["min-zoomed-font-size"].pxValue;if(h<d){return}e.textAlign="center";e.textBaseline="middle";var j,g;var l,k;if(f._private.rscratch.edgeType=="self"){l=f._private.rscratch.selfEdgeMidX;k=f._private.rscratch.selfEdgeMidY}else{if(f._private.rscratch.edgeType=="straight"){l=(f._private.rscratch.startX+f._private.rscratch.endX)/2;k=(f._private.rscratch.startY+f._private.rscratch.endY)/2}else{if(f._private.rscratch.edgeType=="bezier"){l=0.25*f._private.rscratch.startX+2*0.5*0.5*f._private.rscratch.cp2x+(0.5*0.5)*f._private.rscratch.endX;
k=Math.pow(1-0.5,2)*f._private.rscratch.startY+2*(1-0.5)*0.5*f._private.rscratch.cp2y+(0.5*0.5)*f._private.rscratch.endY}}}j=l;g=k;var c=f._private.rstyle;c.labelX=j;c.labelY=g;this.drawText(e,f,j,g)};a.prototype.drawNodeText=function(e,f){if(!f.visible()){return}var j=f._private.style["font-size"].pxValue*f.cy().zoom();var c=f._private.style["min-zoomed-font-size"].pxValue;if(j<c){return}var k,h;var m=this.getNodeWidth(f);var d=this.getNodeHeight(f);var g=f._private.style["text-halign"].strValue;
if(g=="left"){e.textAlign="right";k=f._private.position.x-m/2}else{if(g=="right"){e.textAlign="left";k=f._private.position.x+m/2}else{if(g=="center"){e.textAlign="center";k=f._private.position.x}else{e.textAlign="center";k=f._private.position.x}}}var l=f._private.style["text-valign"].strValue;if(l=="top"){e.textBaseline="bottom";h=f._private.position.y-d/2}else{if(l=="bottom"){e.textBaseline="top";h=f._private.position.y+d/2}else{if(l=="middle"||l=="center"){e.textBaseline="middle";h=f._private.position.y
}else{e.textBaseline="middle";h=f._private.position.y}}}this.drawText(e,f,k,h)};a.prototype.drawText=function(c,g,k,j){var u=1;var q=g.parents();for(var h=0;h<q.length;h++){var r=q[h];var o=r._private.style.opacity.value;u=o*u;if(o===0){return}}var p=g._private.style["font-style"].strValue;var f=g._private.style["font-size"].pxValue+"px";var t=g._private.style["font-family"].strValue;var m=g._private.style["font-variant"].strValue;var d=g._private.style["font-weight"].strValue;c.font=p+" "+d+" "+f+" "+t;
...
var d=h._private.style["background-image"].value[2]||h._private.style["background-image"].value[1];if(d!=undefined){var c=this;var j=this.getCachedImage(d,function(){c.data.canvasNeedsRedraw[a.NODE]=true;c.data.canvasNeedsRedraw[a.DRAG]=true;c.swapCachedImage(d);c.redraw()});if(j.complete==false){a.nodeShapes[c.getNodeShape(h)].drawPath(f,h._private.position.x,h._private.position.y,s,e);f.stroke();f.fillStyle="#555555";f.fill()}else{this.drawInscribedImage(f,j,h)}}else{a.nodeShapes[this.getNodeShape(h)].draw(f,h._private.position.x,h._private.position.y,s,e)
}this.drawPie(f,h);if(h._private.style["border-width"].pxValue>0){a.nodeShapes[this.getNodeShape(h)].drawPath(f,h._private.position.x,h._private.position.y,s,e);f.stroke()}}else{var t=h._private.style["overlay-padding"].pxValue;var m=h._private.style["overlay-opacity"].value;var o=h._private.style["overlay-color"].value;if(m>0){f.fillStyle="rgba( "+o[0]+", "+o[1]+", "+o[2]+", "+m+" )";a.nodeShapes[this.getNodeShape(h)].draw(f,h._private.position.x,h._private.position.y,s+t*2,e+t*2)}}};a.prototype.hasPie=function(e){e=e[0];
for(var d=1;d<=b.style.pieBackgroundN;d++){var c=e._private.style["pie-"+d+"-background-size"].value;if(c>0){return true}}return false};a.prototype.drawPie=function(d,f){f=f[0];if(!this.hasPie(f)){return}var g=this.getNodeWidth(f);var t=this.getNodeHeight(f);var s=f._private.position.x;var p=f._private.position.y;var m=Math.min(g,t)/2;var r=0;d.save();a.nodeShapes[this.getNodeShape(f)].drawPath(d,s,p,g,t);d.clip();for(var j=1;j<=b.style.pieBackgroundN;j++){var u=f._private.style["pie-"+j+"-background-size"].value;
var h=f._private.style["pie-"+j+"-background-color"];var o=u/100;var l=1.5*Math.PI+2*Math.PI*r;var e=2*Math.PI*o;var k=l+e;var c=s+m*Math.cos(l);var q=p+m*Math.sin(l);if(u===0||r>=1||r+o>1){continue}d.beginPath();d.moveTo(s,p);d.arc(s,p,m,l,k);d.closePath();d.fillStyle="rgb("+h.value[0]+","+h.value[1]+","+h.value[2]+")";d.fill();r+=o}d.restore()}})(cytoscape);(function(b){var a=b("renderer","canvas");a.prototype.getPixelRatio=function(){var c=this.data.canvases[0];var d=c.getContext("2d");var f=d.backingStorePixelRatio||d.webkitBackingStorePixelRatio||d.mozBackingStorePixelRatio||d.msBackingStorePixelRatio||d.oBackingStorePixelRatio||d.backingStorePixelRatio||1;
var e=typeof InstallTrigger!=="undefined";if(e){return 1}return(window.devicePixelRatio||1)/f};a.prototype.matchCanvasSize=function(c){var j=this.data;var e=c.clientWidth;var m=c.clientHeight;var f,g=e,k=m;var d=this.getPixelRatio();g*=d;k*=d;var l=j.canvasContainer;l.style.width=e+"px";l.style.height=m+"px";for(var h=0;h<a.CANVAS_LAYERS;h++){f=j.canvases[h];if(f.width!==g||f.height!==k){f.width=g;f.height=k;f.style.width=e+"px";f.style.height=m+"px"}}for(var h=0;h<a.BUFFER_COUNT;h++){f=j.bufferCanvases[h];
if(f.width!==g||f.height!==k){f.width=g;f.height=k}}};a.prototype.renderTo=function(c,d,e){this.redraw({forcedContext:c,forcedZoom:d,forcedPan:e,drawAllLayers:true})};a.prototype.redraw=function(g){g=g||{};var q=g.forcedContext;var s=g.drawAllLayers;var v=g.forcedZoom;var l=g.forcedPan;var o=this;var e=this.getPixelRatio();var f=o.data.cy;var w=o.data;clearTimeout(this.redrawTimeout);if(this.averageRedrawTime===undefined){this.averageRedrawTime=0}var d=1000/60;var j=1000;var p=this.averageRedrawTime;
p=Math.max(d,p);p=Math.min(p,j);if(this.lastDrawTime===undefined){this.lastDrawTime=0}var c=+new Date;var h=c-this.lastDrawTime;var u=h>=p;if(!q){if(!u){clearTimeout(this.redrawTimeout);this.redrawTimeout=setTimeout(function(){o.redraw()},p);return}this.lastDrawTime=c}var m=c;var k=100;function t(){var M=o.getCachedNodes();var B=o.getCachedEdges();if(!q){o.matchCanvasSize(w.container)}var r=f.zoom();var H=v!==undefined?v:r;var L=f.pan();var O={x:L.x,y:L.y};if(l){O=l}H*=e;O.x*=e;O.y*=e;var J=[];for(var N=0;
N<M.length;N++){J.push(M[N])}for(var N=0;N<B.length;N++){J.push(B[N])}function K(Q){Q.setTransform(1,0,0,1,0,0);!q&&Q.clearRect(0,0,Q.canvas.width,Q.canvas.height);if(!s){Q.translate(O.x,O.y);Q.scale(H,H)}if(l){Q.translate(l.x,l.y)}if(v){Q.scale(v,v)}}if(w.canvasNeedsRedraw[a.DRAG]||w.canvasNeedsRedraw[a.NODE]||s){if(o.hideEdgesOnViewport&&(o.pinching||o.hoverData.dragging||o.data.wheel||o.swipePanning)){}else{o.findEdgeControlPoints(B)}var J=o.getCachedZSortedEles();if(f.hasCompoundNodes()){o.updateAllCompounds(J)
}}var F;var D;var A;if(w.canvasNeedsRedraw[a.NODE]||s){if(!F||!D){F=[];D=[];for(var I=0;I<J.length;I++){A=J[I];if(A._private.rscratch.inDragLayer){F.push(A)}else{D.push(A)}}}var C=q||w.canvases[a.NODE].getContext("2d");K(C);for(var I=0;I<D.length;I++){A=D[I];if(A._private.group=="nodes"){o.drawNode(C,A)}else{if(A._private.group=="edges"){o.drawEdge(C,A)}}}for(var I=0;I<D.length;I++){A=D[I];if(A._private.group=="nodes"){o.drawNodeText(C,A)}else{if(A._private.group=="edges"){o.drawEdgeText(C,A)}}if(A._private.group=="nodes"){o.drawNode(C,A,true)
}else{if(A._private.group=="edges"){o.drawEdge(C,A,true)}}}if(!s){w.canvasNeedsRedraw[a.NODE]=false}}if(w.canvasNeedsRedraw[a.DRAG]||s){if(!F||!D){F=[];D=[];for(var I=0;I<J.length;I++){A=J[I];if(A._private.rscratch.inDragLayer){F.push(A)}else{D.push(A)}}}var C=q||w.canvases[a.DRAG].getContext("2d");K(C);var A;for(var I=0;I<F.length;I++){A=F[I];if(A._private.group=="nodes"){o.drawNode(C,A)}else{if(A._private.group=="edges"){o.drawEdge(C,A)}}}for(var I=0;I<F.length;I++){A=F[I];if(A._private.group=="nodes"){o.drawNodeText(C,A)
}else{if(A._private.group=="edges"){o.drawEdgeText(C,A)}}if(A._private.group=="nodes"){o.drawNode(C,A,true)}else{if(A._private.group=="edges"){o.drawEdge(C,A,true)}}}if(!s){w.canvasNeedsRedraw[a.DRAG]=false}}if(w.canvasNeedsRedraw[a.SELECT_BOX]&&!s){var C=q||w.canvases[a.SELECT_BOX].getContext("2d");K(C);var z=f.style()._private.coreStyle;if(w.select[4]==1){var r=w.cy.zoom();var P=z["selection-box-border-width"].value/r;C.lineWidth=P;C.fillStyle="rgba("+z["selection-box-color"].value[0]+","+z["selection-box-color"].value[1]+","+z["selection-box-color"].value[2]+","+z["selection-box-opacity"].value+")";
C.fillRect(w.select[0],w.select[1],w.select[2]-w.select[0],w.select[3]-w.select[1]);if(P>0){C.strokeStyle="rgba("+z["selection-box-border-color"].value[0]+","+z["selection-box-border-color"].value[1]+","+z["selection-box-border-color"].value[2]+","+z["selection-box-opacity"].value+")";C.strokeRect(w.select[0],w.select[1],w.select[2]-w.select[0],w.select[3]-w.select[1])}}if(w.bgActivePosistion){var r=w.cy.zoom();var G=w.bgActivePosistion;C.fillStyle="rgba("+z["active-bg-color"].value[0]+","+z["active-bg-color"].value[1]+","+z["active-bg-color"].value[2]+","+z["active-bg-opacity"].value+")";
C.beginPath();C.arc(G.x,G.y,z["active-bg-size"].pxValue/r,0,2*Math.PI);C.fill()}if(!s){w.canvasNeedsRedraw[a.SELECT_BOX]=false}}var E=+new Date;if(o.averageRedrawTime===undefined){o.averageRedrawTime=E-m}o.averageRedrawTime=o.averageRedrawTime/2+(E-m)/2}if(!q){setTimeout(t,0)}else{t()}if(!q&&!o.initrender){o.initrender=true;f.trigger("initrender")}}})(cytoscape);(function(b){var a=b("renderer","canvas");a.prototype.drawPolygonPath=function(f,d,j,h,c,g){f.translate(d,j);f.scale(h/2,c/2);f.beginPath();
f.moveTo(g[0],g[1]);for(var e=1;e<g.length/2;e++){f.lineTo(g[e*2],g[e*2+1])}f.closePath();f.scale(2/h,2/c);f.translate(-d,-j)};a.prototype.drawPolygon=function(e,d,h,g,c,f){this.drawPolygonPath(e,d,h,g,c,f);e.fill()};a.prototype.drawRoundRectanglePath=function(d,k,j,c,l,g){var e=c/2;var h=l/2;var f=b.math.getRoundRectangleRadius(c,l);d.translate(k,j);d.beginPath();d.moveTo(0,-h);d.arcTo(e,-h,e,0,f);d.arcTo(e,h,0,h,f);d.arcTo(-e,h,-e,0,f);d.arcTo(-e,-h,0,-h,f);d.lineTo(0,-h);d.closePath();d.translate(-k,-j)
};a.prototype.drawRoundRectangle=function(f,e,h,g,d,c){this.drawRoundRectanglePath(f,e,h,g,d,c);f.fill()}})(cytoscape);(function(b){var a=b("renderer","canvas");a.prototype.createBuffer=function(d,e){var c=document.createElement("canvas");c.width=d;c.height=e;return[c,c.getContext("2d")]};a.prototype.png=function(d){var g=this.data;var k=g.cy;var j=k.boundingBox();var f=d.full?Math.ceil(j.w):this.data.container.clientWidth;var c=d.full?Math.ceil(j.h):this.data.container.clientHeight;var h=document.createElement("canvas");
h.width=f;h.height=c;h.style.width=f+"px";h.style.height=c+"px";var e=h.getContext("2d");if(f>0&&c>0){e.clearRect(0,0,f,c);if(d.bg){e.fillStyle=d.bg;e.rect(0,0,f,c);e.fill()}e.globalCompositeOperation="source-over";if(d.full){this.redraw({forcedContext:e,drawAllLayers:true,forcedZoom:1,forcedPan:{x:-j.x1,y:-j.y1}})}else{this.redraw({forcedContext:e,drawAllLayers:true})}}return h.toDataURL("image/png")}})(cytoscape);(function(b){var a=b("renderer","canvas");a.prototype.registerBinding=function(f,e,d,c){this.bindings.push({target:f,event:e,handler:d,useCapture:c});
...
z<r[A]._private.edges.length;z++){r[A]._private.edges[z]._private.rscratch.inDragLayer=B}}};a.prototype.nodeIsDraggable=function(r){if(r._private.style.opacity.value!=0&&r._private.style.visibility.value=="visible"&&r._private.style.display.value=="element"&&!r._private.locked&&r._private.grabbable){return true}return false};p.registerBinding(window,"resize",function(r){p.data.canvasNeedsRedraw[a.NODE]=true;p.matchCanvasSize(p.data.container);p.redraw()},true);p.registerBinding(p.data.container,"contextmenu",function(r){r.preventDefault()
});p.registerBinding(p.data.container,"mousedown",function(B){B.preventDefault();p.hoverData.capture=true;p.hoverData.which=B.which;var r=p.data.cy;var E=p.projectIntoViewport(B.pageX,B.pageY);var F=p.data.select;var A=p.findNearestElement(E[0],E[1],true);var H=p.hoverData.down;var C=p.dragData.possibleDragElements;var D=new b.Event(B,{type:"grab"});if(B.which==3){if(A){A.activate();A.trigger(new b.Event(B,{type:"cxttapstart",cyPosition:{x:E[0],y:E[1]}}));p.hoverData.down=A;p.hoverData.downTime=(new Date()).getTime();
p.hoverData.cxtDragged=false}}else{if(B.which==1){if(A){A.activate()}if(A!=null&&p.nodeIsDraggable(A)){if(A._private.group=="nodes"&&A._private.selected==false){C=p.dragData.possibleDragElements=[];q(A,C);A.trigger(D);if(A._private.style.width.value=="auto"||A._private.style.height.value=="auto"){m(A,true,C)}v(A,true)}if(A._private.group=="nodes"&&A._private.selected==true){C=p.dragData.possibleDragElements=[];var I=false;var G=r.$("node:selected");for(var z=0;z<G.length;z++){if(p.nodeIsDraggable(G[z])){q(G[z],C);
if(!I){A.trigger(D);I=true}if(G[z]._private.style.width.value=="auto"||G[z]._private.style.height.value=="auto"){m(G[z],false,C)}v(G[z],true)}}}A.trigger(new b.Event(B,{type:"mousedown",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(B,{type:"tapstart",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(B,{type:"vmousedown",cyPosition:{x:E[0],y:E[1]}}))}else{if(A==null){r.trigger(new b.Event(B,{type:"mousedown",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(B,{type:"tapstart",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(B,{type:"vmousedown",cyPosition:{x:E[0],y:E[1]}}))
}}p.hoverData.down=A;p.hoverData.downTime=(new Date()).getTime();if(A==null||A.isEdge()){F[4]=1;var J=Math.max(0,a.panOrBoxSelectDelay-(+new Date-p.hoverData.downTime));clearTimeout(p.bgActiveTimeout);p.bgActiveTimeout=setTimeout(function(){if(A){A.unactivate()}p.data.bgActivePosistion={x:E[0],y:E[1]};p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;p.redraw()},J)}}}F[0]=F[2]=E[0];F[1]=F[3]=E[1];p.redraw()},false);p.registerBinding(window,"mousemove",function(O){var F=false;var L=p.hoverData.capture;if(!L){var G=p.findContainerPageCoords();
if(O.pageX>G[0]&&O.pageX<G[0]+p.data.container.clientWidth&&O.pageY>G[1]&&O.pageY<G[1]+p.data.container.clientHeight){}else{return}}var A=p.data.cy;var E=p.projectIntoViewport(O.pageX,O.pageY);var J=p.data.select;var P=p.findNearestElement(E[0],E[1],true);var H=p.hoverData.last;var I=p.hoverData.down;var M=[E[0]-J[2],E[1]-J[3]];var K=p.getCachedNodes();var z=p.getCachedEdges();var C=p.dragData.possibleDragElements;var B=O.shiftKey;F=true;if(P!=null){P.trigger(new b.Event(O,{type:"mousemove",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(O,{type:"vmousemove",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(O,{type:"tapdrag",cyPosition:{x:E[0],y:E[1]}}))
}else{if(P==null){A.trigger(new b.Event(O,{type:"mousemove",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(O,{type:"vmousemove",cyPosition:{x:E[0],y:E[1]}})).trigger(new b.Event(O,{type:"tapdrag",cyPosition:{x:E[0],y:E[1]}}))}}if(p.hoverData.which===3){var D=new b.Event(O,{type:"cxtdrag",cyPosition:{x:E[0],y:E[1]}});if(I){I.trigger(D)}else{A.trigger(D)}p.hoverData.cxtDragged=true}else{if(p.hoverData.dragging){F=true;if(A.panningEnabled()&&A.userPanningEnabled()){var r={x:M[0]*A.zoom(),y:M[1]*A.zoom()};
A.panBy(r)}E=p.projectIntoViewport(O.pageX,O.pageY)}else{if(J[4]==1&&(I==null||I.isEdge())&&(!A.boxSelectionEnabled()||+new Date-p.hoverData.downTime>=a.panOrBoxSelectDelay)&&(Math.abs(J[3]-J[1])+Math.abs(J[2]-J[0])<4)&&A.panningEnabled()&&A.userPanningEnabled()){p.hoverData.dragging=true;J[4]=0}else{if(A.boxSelectionEnabled()&&Math.pow(J[2]-J[0],2)+Math.pow(J[3]-J[1],2)>7&&J[4]){clearTimeout(p.bgActiveTimeout);p.data.bgActivePosistion=undefined}if(I&&I.isEdge()&&I.active()){I.unactivate()}if(P!=H){if(H){H.trigger(new b.Event(O,{type:"mouseout",cyPosition:{x:E[0],y:E[1]}}))
}if(P){P.trigger(new b.Event(O,{type:"mouseover",cyPosition:{x:E[0],y:E[1]}}))}p.hoverData.last=P}if(I&&I.isNode()&&p.nodeIsDraggable(I)){p.dragData.didDrag=true;var Q=[];for(var N=0;N<C.length;N++){if(C[N]._private.group=="nodes"&&p.nodeIsDraggable(C[N])){C[N]._private.position.x+=M[0];C[N]._private.position.y+=M[1];Q.push(C[N])}}(new b.Collection(A,Q)).trigger("drag").trigger("position");if(J[2]==J[0]&&J[3]==J[1]){p.data.canvasNeedsRedraw[a.NODE]=true}p.data.canvasNeedsRedraw[a.DRAG]=true}if(A.boxSelectionEnabled()){p.data.canvasNeedsRedraw[a.SELECT_BOX]=true
}F=true}}}J[2]=E[0];J[3]=E[1];p.redraw();if(F){if(O.stopPropagation){O.stopPropagation()}if(O.preventDefault){O.preventDefault()}return false}},false);p.registerBinding(window,"mouseup",function(S){var N=p.hoverData.capture;if(!N){return}p.hoverData.capture=false;var z=p.data.cy;var F=p.projectIntoViewport(S.pageX,S.pageY);var L=p.data.select;var T=p.findNearestElement(F[0],F[1],true);var M=p.getCachedNodes();var r=p.getCachedEdges();var C=p.dragData.possibleDragElements;var H=p.hoverData.down;var B=S.shiftKey;
p.data.bgActivePosistion=undefined;clearTimeout(p.bgActiveTimeout);if(H){H.unactivate()}if(p.hoverData.which===3){var D=new b.Event(S,{type:"cxttapend",cyPosition:{x:F[0],y:F[1]}});if(H){H.trigger(D)}else{z.trigger(D)}if(!p.hoverData.cxtDragged){var K=new b.Event(S,{type:"cxttap",cyPosition:{x:F[0],y:F[1]}});if(H){H.trigger(K)}else{z.trigger(K)}}p.hoverData.cxtDragged=false;p.hoverData.which=null}else{if((H==null)&&!p.dragData.didDrag&&!(Math.pow(L[2]-L[0],2)+Math.pow(L[3]-L[1],2)>7&&L[4])&&!p.hoverData.dragging){z.$(":selected").unselect();
if(C.length>0){p.data.canvasNeedsRedraw[a.NODE]=true}p.dragData.possibleDragElements=C=[]}if(T!=null){T.trigger(new b.Event(S,{type:"mouseup",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"tapend",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"vmouseup",cyPosition:{x:F[0],y:F[1]}}))}else{if(T==null){z.trigger(new b.Event(S,{type:"mouseup",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"tapend",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"vmouseup",cyPosition:{x:F[0],y:F[1]}}))
}}if(Math.pow(L[2]-L[0],2)+Math.pow(L[3]-L[1],2)==0){if(T!=null){T.trigger(new b.Event(S,{type:"click",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"tap",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"vclick",cyPosition:{x:F[0],y:F[1]}}))}else{if(T==null){z.trigger(new b.Event(S,{type:"click",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"tap",cyPosition:{x:F[0],y:F[1]}})).trigger(new b.Event(S,{type:"vclick",cyPosition:{x:F[0],y:F[1]}}))}}}if(T==H&&!p.dragData.didDrag){if(T!=null&&T._private.selectable){if(z.selectionType()==="additive"){if(T.selected()){T.unselect()
}else{T.select()}}else{if(!B){z.$(":selected").unselect()}T.select()}v(T,false);p.data.canvasNeedsRedraw[a.NODE]=true}}else{if(T==H){if(T!=null&&T._private.grabbed){var O=z.$(":grabbed");for(var R=0;R<O.length;R++){var I=O[R];I._private.grabbed=false;var J=I._private.edges;for(var Q=0;Q<J.length;Q++){J[Q]._private.rscratch.inDragLayer=false}v(I,false)}O.trigger("free")}}}if(z.boxSelectionEnabled()&&Math.pow(L[2]-L[0],2)+Math.pow(L[3]-L[1],2)>7&&L[4]){var A=[];var G=p.getAllInBox(L[0],L[1],L[2],L[3]);
var P=new b.Event(S,{type:"select"});for(var R=0;R<G.length;R++){if(G[R]._private.selectable){C.push(G[R]);A.push(G[R])}}var E=new b.Collection(z,A);if(z.selectionType()==="additive"){E.select()}else{if(!B){z.$(":selected").unselect()}E.select()}if(G.length>0){p.data.canvasNeedsRedraw[a.NODE]=true}}p.hoverData.dragging=false;if(!L[4]){for(var R=0;R<C.length;R++){if(C[R]._private.group=="nodes"){C[R]._private.rscratch.inDragLayer=false;var J=C[R]._private.edges;for(var Q=0;Q<J.length;Q++){J[Q]._private.rscratch.inDragLayer=false
}v(C[R],false)}else{if(C[R]._private.group=="edges"){C[R]._private.rscratch.inDragLayer=false}}}if(H){H.trigger("free")}p.data.canvasNeedsRedraw[a.DRAG]=true;p.data.canvasNeedsRedraw[a.NODE]=true}}L[4]=0;p.hoverData.down=null;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;p.dragData.didDrag=false;p.redraw()},false);var j=function(z){var C=p.data.cy;var B=p.projectIntoViewport(z.pageX,z.pageY);var A=[B[0]*C.zoom()+C.pan().x,B[1]*C.zoom()+C.pan().y];if(C.panningEnabled()&&C.userPanningEnabled()&&C.zoomingEnabled()&&C.userZoomingEnabled()){z.preventDefault();
var r=z.wheelDeltaY/1000||z.wheelDelta/1000||z.detail/-32||-z.deltaY/500;C.zoom({level:C.zoom()*Math.pow(10,r),renderedPosition:{x:A[0],y:A[1]}})}};p.registerBinding(p.data.container,"wheel",j,true);p.registerBinding(p.data.container,"mousewheel",j,true);p.registerBinding(p.data.container,"DOMMouseScroll",j,true);p.registerBinding(p.data.container,"MozMousePixelScroll",function(r){},false);p.registerBinding(p.data.container,"mouseout",function(r){var z=p.projectIntoViewport(r.pageX,r.pageY);p.data.cy.trigger(new b.Event(r,{type:"mouseout",cyPosition:{x:z[0],y:z[1]}}))
},false);p.registerBinding(p.data.container,"mouseover",function(r){var z=p.projectIntoViewport(r.pageX,r.pageY);p.data.cy.trigger(new b.Event(r,{type:"mouseover",cyPosition:{x:z[0],y:z[1]}}))},false);var d,k,s,w;var t;var g,f;var h,u;var l=p.data.container.clientWidth,o=p.data.container.clientHeight;var c;function e(z,B,r,A){return Math.sqrt((r-z)*(r-z)+(A-B)*(A-B))}p.registerBinding(p.data.container,"touchstart",function(S){clearTimeout(this.threeFingerSelectTimeout);if(S.target!==p.data.link){S.preventDefault()
}p.touchData.capture=true;p.data.bgActivePosistion=undefined;var B=p.data.cy;var L=p.getCachedNodes();var A=p.getCachedEdges();var z=p.touchData.now;var P=p.touchData.earlier;if(S.touches[0]){var D=p.projectIntoViewport(S.touches[0].pageX,S.touches[0].pageY);z[0]=D[0];z[1]=D[1]}if(S.touches[1]){var D=p.projectIntoViewport(S.touches[1].pageX,S.touches[1].pageY);z[2]=D[0];z[3]=D[1]}if(S.touches[2]){var D=p.projectIntoViewport(S.touches[2].pageX,S.touches[2].pageY);z[4]=D[0];z[5]=D[1]}if(S.touches[1]){function R(U){for(var V=0;
V<U.length;V++){U[V]._private.grabbed=false;U[V]._private.rscratch.inDragLayer=false;if(U[V].active()){U[V].unactivate()}}}R(L);R(A);var C=p.findContainerPageCoords();u=C[1];h=C[0];d=S.touches[0].pageX-h;k=S.touches[0].pageY-u;s=S.touches[1].pageX-h;w=S.touches[1].pageY-u;c=0<=d&&d<=l&&0<=s&&s<=l&&0<=k&&k<=o&&0<=w&&w<=o;var K=B.pan();var r=B.zoom();t=e(d,k,s,w);g=[(d+s)/2,(k+w)/2];f=[(g[0]-K.x)/r,(g[1]-K.y)/r];if(t<100){var F=p.findNearestElement(z[0],z[1],true);var E=p.findNearestElement(z[2],z[3],true);
if(F&&F.isNode()){F.activate().trigger(new b.Event(S,{type:"cxttapstart",cyPosition:{x:z[0],y:z[1]}}));p.touchData.start=F}else{if(E&&E.isNode()){E.activate().trigger(new b.Event(S,{type:"cxttapstart",cyPosition:{x:z[0],y:z[1]}}));p.touchData.start=E}else{B.trigger(new b.Event(S,{type:"cxttapstart",cyPosition:{x:z[0],y:z[1]}}));p.touchData.start=null}}if(p.touchData.start){p.touchData.start._private.grabbed=false}p.touchData.cxt=true;p.touchData.cxtDragged=false;p.data.bgActivePosistion=undefined;
p.redraw();return}}if(S.touches[2]){}else{if(S.touches[1]){}else{if(S.touches[0]){var T=p.findNearestElement(z[0],z[1],true);if(T!=null){T.activate();p.touchData.start=T;if(T._private.group=="nodes"&&p.nodeIsDraggable(T)){var G=p.dragData.touchDragEles=[];q(T,G);T.trigger("grab");if(T.selected()){G=p.dragData.touchDragEles=[];var I=B.$("node:selected");for(var M=0;M<I.length;M++){var Q=I[M];if(p.nodeIsDraggable(Q)){G.push(Q);Q._private.rscratch.inDragLayer=true;var H=Q._private.edges;for(var N=0;
N<H.length;N++){H[N]._private.rscratch.inDragLayer=true}if(Q._private.style.width.value=="auto"||Q._private.style.height.value=="auto"){m(Q,false,G)}v(Q,true)}}}else{if(T._private.style.width.value=="auto"||T._private.style.height.value=="auto"){m(T,true,G)}v(T,true)}}T.trigger(new b.Event(S,{type:"touchstart",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(S,{type:"tapstart",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(S,{type:"vmousdown",cyPosition:{x:z[0],y:z[1]}}))}if(T==null){B.trigger(new b.Event(S,{type:"touchstart",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(S,{type:"tapstart",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(S,{type:"vmousedown",cyPosition:{x:z[0],y:z[1]}}));
p.data.bgActivePosistion={x:D[0],y:D[1]};p.data.canvasNeedsRedraw[a.SELECT_BOX]=true}for(var O=0;O<z.length;O++){P[O]=z[O];p.touchData.startPosition[O]=z[O]}p.touchData.singleTouchMoved=false;p.touchData.singleTouchStartTime=+new Date;var J=setTimeout(function(){if(p.touchData.singleTouchMoved==false&&(+new Date)-p.touchData.singleTouchStartTime>250){if(p.touchData.start){p.touchData.start.trigger(new b.Event(S,{type:"taphold",cyPosition:{x:z[0],y:z[1]}}))}else{p.data.cy.trigger(new b.Event(S,{type:"taphold",cyPosition:{x:z[0],y:z[1]}}));
B.$(":selected").unselect()}}},1000)}}}p.redraw()},false);p.registerBinding(window,"touchmove",function(ag){var Z=p.data.select;var N=p.touchData.capture;N&&ag.preventDefault();var L=p.data.cy;var V=p.getCachedNodes();var F=p.getCachedEdges();var Y=p.touchData.now;var z=p.touchData.earlier;if(ag.touches[0]){var Q=p.projectIntoViewport(ag.touches[0].pageX,ag.touches[0].pageY);Y[0]=Q[0];Y[1]=Q[1]}if(ag.touches[1]){var Q=p.projectIntoViewport(ag.touches[1].pageX,ag.touches[1].pageY);Y[2]=Q[0];Y[3]=Q[1]
}if(ag.touches[2]){var Q=p.projectIntoViewport(ag.touches[2].pageX,ag.touches[2].pageY);Y[4]=Q[0];Y[5]=Q[1]}var B=[];for(var ad=0;ad<Y.length;ad++){B[ad]=Y[ad]-z[ad]}if(N&&p.touchData.cxt){var P=ag.touches[0].pageX-h,C=ag.touches[0].pageY-u;var K=ag.touches[1].pageX-h,r=ag.touches[1].pageY-u;var T=e(P,C,K,r);var ae=T/t;if(ae>=1.5||T>=150){p.touchData.cxt=false;if(p.touchData.start){p.touchData.start.unactivate();p.touchData.start=null}p.data.bgActivePosistion=undefined;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;
var A=new b.Event(ag,{type:"cxttapend",cyPosition:{x:Y[0],y:Y[1]}});if(p.touchData.start){p.touchData.start.trigger(A)}else{L.trigger(A)}}}if(N&&p.touchData.cxt){var A=new b.Event(ag,{type:"cxtdrag",cyPosition:{x:Y[0],y:Y[1]}});p.data.bgActivePosistion=undefined;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;if(p.touchData.start){p.touchData.start.trigger(A)}else{L.trigger(A)}if(p.touchData.start){p.touchData.start._private.grabbed=false}p.touchData.cxtDragged=true}else{if(N&&ag.touches[2]&&L.boxSelectionEnabled()){p.data.bgActivePosistion=undefined;
clearTimeout(this.threeFingerSelectTimeout);this.lastThreeTouch=+new Date;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;if(!Z||Z.length===0||Z[0]===undefined){Z[0]=(Y[0]+Y[2]+Y[4])/3;Z[1]=(Y[1]+Y[3]+Y[5])/3;Z[2]=(Y[0]+Y[2]+Y[4])/3+1;Z[3]=(Y[1]+Y[3]+Y[5])/3+1}else{Z[2]=(Y[0]+Y[2]+Y[4])/3;Z[3]=(Y[1]+Y[3]+Y[5])/3}Z[4]=1}else{if(N&&ag.touches[1]&&L.zoomingEnabled()&&L.panningEnabled()&&L.userZoomingEnabled()&&L.userPanningEnabled()){p.data.bgActivePosistion=undefined;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;
var P=ag.touches[0].pageX-h,C=ag.touches[0].pageY-u;var K=ag.touches[1].pageX-h,r=ag.touches[1].pageY-u;var T=e(P,C,K,r);var ae=T/t;if(ae!=1&&c){var ai=P-d;var ah=C-k;var U=K-s;var S=r-w;var ac=(ai+U)/2;var aa=(ah+S)/2;var E=L.zoom();var D=E*ae;var H=L.pan();var X=f[0]*E+H.x;var W=f[1]*E+H.y;var G={x:-D/E*(X-H.x-ac)+X,y:-D/E*(W-H.y-aa)+W};L._private.zoom=D;L._private.pan=G;L.trigger("pan zoom").notify("viewport");t=T;d=P;k=C;s=K;w=r;p.pinching=true}if(ag.touches[0]){var Q=p.projectIntoViewport(ag.touches[0].pageX,ag.touches[0].pageY);
Y[0]=Q[0];Y[1]=Q[1]}if(ag.touches[1]){var Q=p.projectIntoViewport(ag.touches[1].pageX,ag.touches[1].pageY);Y[2]=Q[0];Y[3]=Q[1]}if(ag.touches[2]){var Q=p.projectIntoViewport(ag.touches[2].pageX,ag.touches[2].pageY);Y[4]=Q[0];Y[5]=Q[1]}}else{if(ag.touches[0]){var O=p.touchData.start;var I=p.touchData.last;if(O!=null&&O._private.group=="nodes"&&p.nodeIsDraggable(O)){var J=p.dragData.touchDragEles;for(var ab=0;ab<J.length;ab++){var M=J[ab];if(p.nodeIsDraggable(M)){p.dragData.didDrag=true;M._private.position.x+=B[0];
M._private.position.y+=B[1]}}(new b.Collection(L,J)).trigger("drag").trigger("position");p.data.canvasNeedsRedraw[a.DRAG]=true;if(p.touchData.startPosition[0]==z[0]&&p.touchData.startPosition[1]==z[1]){p.data.canvasNeedsRedraw[a.NODE]=true}}if(O!=null){O.trigger(new b.Event(ag,{type:"touchmove",cyPosition:{x:Y[0],y:Y[1]}}));O.trigger(new b.Event(ag,{type:"tapdrag",cyPosition:{x:Y[0],y:Y[1]}}));O.trigger(new b.Event(ag,{type:"vmousemove",cyPosition:{x:Y[0],y:Y[1]}}))}if(O==null){var R=p.findNearestElement(Y[0],Y[1],true);
if(R!=null){R.trigger(new b.Event(ag,{type:"touchmove",cyPosition:{x:Y[0],y:Y[1]}}));R.trigger(new b.Event(ag,{type:"tapdrag",cyPosition:{x:Y[0],y:Y[1]}}));R.trigger(new b.Event(ag,{type:"vmousemove",cyPosition:{x:Y[0],y:Y[1]}}))}if(R==null){L.trigger(new b.Event(ag,{type:"touchmove",cyPosition:{x:Y[0],y:Y[1]}}));L.trigger(new b.Event(ag,{type:"tapdrag",cyPosition:{x:Y[0],y:Y[1]}}));L.trigger(new b.Event(ag,{type:"vmousemove",cyPosition:{x:Y[0],y:Y[1]}}))}}p.touchData.last=R;for(var af=0;af<Y.length;
af++){if(Y[af]&&p.touchData.startPosition[af]&&Math.abs(Y[af]-p.touchData.startPosition[af])>4){p.touchData.singleTouchMoved=true}}if(N&&(O==null||O.isEdge())&&L.panningEnabled()&&L.userPanningEnabled()){if(O){O.unactivate();if(!p.data.bgActivePosistion){p.data.bgActivePosistion={x:Y[0],y:Y[1]}}p.data.canvasNeedsRedraw[a.SELECT_BOX]=true}L.panBy({x:B[0]*L.zoom(),y:B[1]*L.zoom()});p.swipePanning=true;var Q=p.projectIntoViewport(ag.touches[0].pageX,ag.touches[0].pageY);Y[0]=Q[0];Y[1]=Q[1]}}}}}for(var ad=0;
ad<Y.length;ad++){z[ad]=Y[ad]}p.redraw()},false);p.registerBinding(window,"touchend",function(V){var M=p.touchData.capture;if(!M){return}p.touchData.capture=false;V.preventDefault();var J=p.data.select;p.swipePanning=false;var B=p.data.cy;var L=p.getCachedNodes();var A=p.getCachedEdges();var z=p.touchData.now;var S=p.touchData.earlier;var D=p.touchData.start;if(V.touches[0]){var E=p.projectIntoViewport(V.touches[0].pageX,V.touches[0].pageY);z[0]=E[0];z[1]=E[1]}if(V.touches[1]){var E=p.projectIntoViewport(V.touches[1].pageX,V.touches[1].pageY);
z[2]=E[0];z[3]=E[1]}if(V.touches[2]){var E=p.projectIntoViewport(V.touches[2].pageX,V.touches[2].pageY);z[4]=E[0];z[5]=E[1]}if(p.touchData.cxt){ctxTapend=new b.Event(V,{type:"cxttapend",cyPosition:{x:z[0],y:z[1]}});if(D){D.unactivate();D.trigger(ctxTapend)}else{B.trigger(ctxTapend)}if(!p.touchData.cxtDragged){var K=new b.Event(V,{type:"cxttap",cyPosition:{x:z[0],y:z[1]}});if(D){D.trigger(K)}else{B.trigger(K)}}if(p.touchData.start){p.touchData.start._private.grabbed=false}p.touchData.cxt=false;p.touchData.start=null;
p.redraw();return}var r=+new Date;if(!V.touches[2]&&B.boxSelectionEnabled()){clearTimeout(this.threeFingerSelectTimeout);var C=[];var G=p.getAllInBox(J[0],J[1],J[2],J[3]);J[0]=undefined;J[1]=undefined;J[2]=undefined;J[3]=undefined;J[4]=0;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;var Q=new b.Event("select");for(var R=0;R<G.length;R++){if(G[R]._private.selectable){C.push(G[R])}}var F=(new b.Collection(B,C));if(B.selectionType()==="single"){B.$(":selected").unselect()}F.select();if(G.length>0){p.data.canvasNeedsRedraw[a.NODE]=true
}}if(!V.touches[1]){p.pinching=false}var P=false;if(D!=null){D._private.active=false;P=true;D.trigger("unactivate")}if(V.touches[2]){p.data.bgActivePosistion=undefined;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true}else{if(V.touches[1]){}else{if(V.touches[0]){}else{if(!V.touches[0]){p.data.bgActivePosistion=undefined;p.data.canvasNeedsRedraw[a.SELECT_BOX]=true;if(D!=null){if(D._private.grabbed==true){D._private.grabbed=false;D.trigger("free");D._private.rscratch.inDragLayer=false}var I=D._private.edges;
for(var O=0;O<I.length;O++){I[O]._private.rscratch.inDragLayer=false}v(D,false);if(D.selected()){var H=B.$("node:selected");for(var N=0;N<H.length;N++){var T=H[N];T._private.rscratch.inDragLayer=false;var I=T._private.edges;for(var O=0;O<I.length;O++){I[O]._private.rscratch.inDragLayer=false}v(T,false)}}p.data.canvasNeedsRedraw[a.DRAG]=true;p.data.canvasNeedsRedraw[a.NODE]=true;D.trigger(new b.Event(V,{type:"touchend",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"tapend",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"vmouseup",cyPosition:{x:z[0],y:z[1]}}));
p.touchData.start=null}else{var U=p.findNearestElement(z[0],z[1],true);if(U!=null){U.trigger(new b.Event(V,{type:"touchend",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"tapend",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"vmouseup",cyPosition:{x:z[0],y:z[1]}}))}if(U==null){B.trigger(new b.Event(V,{type:"touchend",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"tapend",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"vmouseup",cyPosition:{x:z[0],y:z[1]}}))
}}if(D!=null&&!p.dragData.didDrag&&D._private.selectable&&(Math.sqrt(Math.pow(p.touchData.startPosition[0]-z[0],2)+Math.pow(p.touchData.startPosition[1]-z[1],2)))<6){if(B.selectionType()==="single"){B.$(":selected").unselect();D.select()}else{if(D.selected()){D.unselect()}else{D.select()}}P=true;p.data.canvasNeedsRedraw[a.NODE]=true}if(p.touchData.singleTouchMoved==false){if(D){D.trigger(new b.Event(V,{type:"tap",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"vclick",cyPosition:{x:z[0],y:z[1]}}))
}else{B.trigger(new b.Event(V,{type:"tap",cyPosition:{x:z[0],y:z[1]}})).trigger(new b.Event(V,{type:"vclick",cyPosition:{x:z[0],y:z[1]}}))}}p.touchData.singleTouchMoved=true}}}}for(var O=0;O<z.length;O++){S[O]=z[O]}p.dragData.didDrag=false;if(P&&D){D.updateStyle(false)}p.redraw()},false)}})(cytoscape);(function(g){var e=g("renderer","canvas");var c=e.prototype;var a=e.nodeShapes={};a.ellipse={draw:function(l,p,o,m,k){a.ellipse.drawPath(l,p,o,m,k);l.fill()},drawPath:function(l,p,o,m,k){l.beginPath();
l.translate(p,o);l.scale(m/2,k/2);l.arc(0,0,1,0,Math.PI*2*0.999,false);l.closePath();l.scale(2/m,2/k);l.translate(-p,-o)},intersectLine:function(q,p,o,m,l,s,r){var k=g.math.intersectLineEllipse(l,s,q,p,o/2+r,m/2+r);return k},intersectBox:function(m,s,k,q,l,t,p,o,r){return g.math.boxIntersectEllipse(m,s,k,q,r,l,t,p,o)},checkPointRough:function(l,r,q,m,k,p,o){return true},checkPoint:function(l,r,q,m,k,p,o){l-=p;r-=o;l/=(m/2+q);r/=(k/2+q);return(Math.pow(l,2)+Math.pow(r,2)<=1)}};a.triangle={points:g.math.generateUnitNgonPoints(3,0),draw:function(l,p,o,m,k){c.drawPolygon(l,p,o,m,k,a.triangle.points)
...
}return{x:Math.round(Math.random()*j),y:Math.round(Math.random()*d)}});k.one("layoutready",h.ready);k.trigger("layoutready");if(h.fit){k.fit(h.padding)}k.one("layoutstop",h.stop);k.trigger("layoutstop")};b.prototype.stop=function(){};a("layout","random",b)})(cytoscape);(function(a){var c={fit:true,padding:30,rows:undefined,columns:undefined,position:function(d){},ready:undefined,stop:undefined};function b(d){this.options=a.util.extend({},c,d)}b.prototype.run=function(){var K=this.options;var h=K;
var g=K.cy;var C=g.nodes();var f=g.edges();var w=g.container();var B=w.clientWidth;var A=w.clientHeight;if(A==0||B==0){C.positions(function(){return{x:0,y:0}})}else{var j=C.size();var u=Math.sqrt(j*A/B);var t=Math.round(u);var v=Math.round(B/A*u);function p(M){if(M==undefined){return Math.min(t,v)}else{var L=Math.min(t,v);if(L==t){t=M}else{v=M}}}function e(M){if(M==undefined){return Math.max(t,v)}else{var L=Math.max(t,v);if(L==t){t=M}else{v=M}}}if(h.rows!=null&&h.columns!=null){t=h.rows;v=h.columns
}else{if(h.rows!=null&&h.columns==null){t=h.rows;v=Math.ceil(j/t)}else{if(h.rows==null&&h.columns!=null){v=h.columns;t=Math.ceil(j/v)}else{if(v*t>j){var J=p();var z=e();if((J-1)*z>=j){p(J-1)}else{if((z-1)*J>=j){e(z-1)}}}else{while(v*t<j){var J=p();var z=e();if((z+1)*J>=j){e(z+1)}else{p(J+1)}}}}}}var G=B/v;var d=A/t;var I={};function m(M,L){return I["c-"+M+"-"+L]?true:false}function F(M,L){I["c-"+M+"-"+L]=true}var o=0;var k=0;function r(){k++;if(k>=v){k=0;o++}}var s={};for(var H=0;H<C.length;H++){var E=C[H];
var D=h.position(E);if(D&&(D.row!==undefined||D.col!==undefined)){var l={row:D.row,col:D.col};if(l.col===undefined){l.col=0;while(m(l.row,l.col)){l.col++}}else{if(l.row===undefined){l.row=0;while(m(l.row,l.col)){l.row++}}}s[E.id()]=l;F(l.row,l.col)}}var q=false;C.positions(function(N,M){var L,P;if(M.locked()){return false}var O=s[M.id()];if(O){L=O.col*G+G/2;P=O.row*d+d/2}else{while(m(o,k)){r()}L=k*G+G/2;P=o*d+d/2;F(o,k);r()}return{x:L,y:P}})}if(K.fit){g.fit(h.padding)}g.one("layoutready",K.ready);
g.trigger("layoutready");g.one("layoutstop",K.stop);g.trigger("layoutstop")};b.prototype.stop=function(){};a("layout","grid",b)})(cytoscape);(function(a){var c={fit:true,ready:undefined,stop:undefined,positions:undefined,zoom:undefined,pan:undefined,padding:30};function b(d){this.options=a.util.extend(true,{},c,d)}b.prototype.run=function(){var g=this.options;var j=g.cy;var f=j.nodes();var e=j.edges();var d=j.container();function h(k){if(g.positions==null){return null}if(g.positions[k._private.data.id]==null){return null
}return g.positions[k._private.data.id]}f.positions(function(l,m){var k=h(m);if(m.locked()||k==null){return false}return k});if(g.pan!=null){j.pan(g.pan)}if(g.zoom!=null){j.zoom(g.zoom)}j.one("layoutready",g.ready);j.trigger("layoutready");if(g.fit){j.fit(g.padding)}j.one("layoutstop",g.stop);j.trigger("layoutstop")};a("layout","preset",b);a("core","presetLayout",function(){var f=this;var d={};var e={};f.nodes().each(function(g,h){e[h.data("id")]=h.position()});d.positions=e;d.name="preset";d.zoom=f.zoom();
d.pan=f.pan();return d})})(cytoscape);(function(a){var b={liveUpdate:true,ready:undefined,stop:undefined,maxSimulationTime:4000,fit:true,padding:[50,50,50,50],simulationBounds:undefined,ungrabifyWhileSimulating:true,repulsion:undefined,stiffness:undefined,friction:undefined,gravity:true,fps:undefined,precision:undefined,nodeMass:undefined,edgeLength:undefined,stepSize:1,stableEnergy:function(d){var f=d;return(f.max<=0.5)||(f.mean<=0.3)}};function c(d){this.options=a.util.extend({},b,d)}c.prototype.run=function(){var l=this.options;
var k=l.cy;var z=k.nodes();var j=k.edges();var r=k.container();var w=r.clientWidth;var t=r.clientHeight;var u=l.simulationBounds;if(l.simulationBounds){w=u[2]-u[0];t=u[3]-u[1]}else{l.simulationBounds=[0,0,w,t]}var B=l.simulationBounds;B.x1=B[0];B.y1=B[1];B.x2=B[2];B.y2=B[3];if(k.nodes().size()<=1){if(l.fit){k.reset()}k.nodes().position({x:Math.round((B.x1+B.x2)/2),y:Math.round((B.y1+B.y2)/2)});k.one("layoutstop",l.stop);k.trigger("layoutstop");k.one("layoutstop",l.stop);k.trigger("layoutstop");return
}var o=this.system=arbor.ParticleSystem(l.repulsion,l.stiffness,l.friction,l.gravity,l.fps,l.dt,l.precision);this.system=o;if(l.liveUpdate&&l.fit){k.reset()}var v=250;var h;var q=false;var g=+new Date;var s={init:function(C){},redraw:function(){var D=o.energy();if(l.stableEnergy!=null&&D!=null&&D.n>0&&l.stableEnergy(D)){o.stop();return}clearTimeout(h);h=setTimeout(A,v);var E=[];o.eachNode(function(K,F){var J=K.name;var H=K.data;var G=H.element;if(G==null){return}var I=G._private.position;if(!G.locked()&&!G.grabbed()){I.x=B.x1+F.x;
I.y=B.y1+F.y;E.push(G)}});var C=(+new Date-g)>=16;if(l.liveUpdate&&E.length>0&&C){new a.Collection(k,E).rtrigger("position");g=+new Date}if(!q){q=true;k.one("layoutready",l.ready);k.trigger("layoutready")}}};o.renderer=s;o.screenSize(w,t);o.screenPadding(l.padding[0],l.padding[1],l.padding[2],l.padding[3]);o.screenStep(l.stepSize);function p(C,D){if(D==null){return undefined}else{if(typeof D==typeof function(){}){return D.apply(C,[C._private.data,{nodes:z.length,edges:j.length,element:C}])}else{return D
}}}function d(G){var J=G.x;var H=G.y;var K=w;var E=t;var D=-2;var L=2;var I=-2;var C=2;var F=4;return{x:J/K*F+D,y:H/E*F+L}}var m=function(D){grabbed=this;var E=o.fromScreen(this.position());var C=arbor.Point(E.x,E.y);this.scratch().arbor.p=C;switch(D.type){case"grab":this.scratch().arbor.fixed=true;break;case"dragstop":this.scratch().arbor.fixed=false;this.scratch().arbor.tempMass=1000;break}};z.bind("grab drag dragstop",m);z.each(function(E,F){var H=this._private.data.id;var D=p(this,l.nodeMass);
