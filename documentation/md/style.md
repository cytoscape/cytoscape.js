 ...
 * **`<pos>-arrow-shape`** : The shape of the edge's source arrow; may be `tee`, `triangle`, `triangle-tee`, `triangle-cross`, `triangle-backcurve`, `square`, `circle`, `diamond`, `chevron` or `none`.
