;( function( $$ ) {
  ...
  SpreadLayout.prototype.run = function() {
    ...
    if( simulationBounds ) {
      simBB.x1 = simulationBounds.x1 + padding;
      simBB.y1 = simulationBounds.y1 + padding;
      simBB.x2 = simulationBounds.x2 - padding;
      simBB.y2 = simulationBounds.y2 - padding;
    } else {
      simBB.x1 = padding;
      simBB.y1 = padding;
    ...
    t1.pass( pData ).run( function( pData ) {
      ...
      var iterations = 400; // TODO reduce this value
      var frLayoutManager = new foograph.ForceDirectedVertexLayout( lWidth, lHeight, iterations, false, 20 );
