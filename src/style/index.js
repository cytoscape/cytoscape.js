...
(function(){
  ...
  // define aliases
  var aliases = Style.aliases = styfn.aliases = [
    { name: 'content', pointsTo: 'label' }
  ];

  // pie backgrounds for nodes
  Style.pieBackgroundN = styfn.pieBackgroundN = 16; // because the pie properties are numbered, give access to a constant N (for renderer use)
