...
(function(){
  ...
  styfn.types = {
    ...
    acuteCornerStrategy: { enums: [ 'adjust-distance', 'adjust-radius' ] , multiple: true },
  ...
  let edgeLine = [
    ...
    { name: 'acute-corner-strategy', type: t.acuteCornerStrategy, triggersBounds: diff.any },
...
styfn.getDefaultProperties = function(){
  ...
  let rawProps = util.extend( {
    ...
    'segment-radii': 15,
    'acute-corner-strategy': 'adjust-distance',
    'taxi-turn': '50%',
    'taxi-radius': 15,
