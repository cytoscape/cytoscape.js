...
(function(){
  ...
  let overlay = [
    ...
    { name: 'overlay-fill', type: t.fill },
    { name: 'overlay-gradient-stop-colors', type: t.colors },
    { name: 'overlay-gradient-stop-positions', type: t.percentages },
    { name: 'overlay-gradient-direction', type: t.gradientDirection },
  ...
  let underlay = [
    ...
    { name: 'underlay-fill', type: t.fill },
    { name: 'underlay-gradient-stop-colors', type: t.colors },
    { name: 'underlay-gradient-stop-positions', type: t.percentages },
    { name: 'underlay-gradient-direction', type: t.gradientDirection },
...
styfn.getDefaultProperties = function(){
  ...
  let rawProps = util.extend( {
    ...
    'overlay-color': '#000',
    'overlay-fill': 'solid',
    'overlay-gradient-stop-colors': '#999',
    'overlay-gradient-stop-positions': '0%',
    'overlay-gradient-direction': 'to-bottom',
    'overlay-padding': 10,
    ...
    'underlay-color': '#000',
    'underlay-fill': 'solid',
    'underlay-gradient-stop-colors': '#999',
    'underlay-gradient-stop-positions': '0%',
