...
describe('gpu/algorithms: search + paths', function () {
  ...
  describe('eles.kruskal()', function () {
    it('finds the minimum spanning tree', function () {
      ...
      expect(kruskal.same(eles(a, b, c, d, e, f, ae, cf, cd, ab, bc))).to.be
        .true;
    });
  ...
  describe('eles.aStar()', function () {
    ...
    it('directed, null heuristic, unweighted: unreachable', function () {
      var res = cy
        .elements()
        .aStar({ root: c, goal: a, directed: true, heuristic: nullH });
    ...
    it('directed, null heuristic, unweighted (2)', function () {
      var res = cy
        .elements()
        .aStar({ root: a, goal: d, directed: true, heuristic: nullH });
    ...
    it('undirected, null heuristic, weighted', function () {
      var res = cy
        .elements()
        .aStar({ root: a, goal: d, directed: false, weight, heuristic: nullH });
    ...
    it('directed, null heuristic, weighted', function () {
      var res = cy
        .elements()
        .aStar({ root: a, goal: d, directed: true, weight, heuristic: nullH });
    ...
    it('directed, weighted, not found', function () {
      var res = cy
        .elements()
        .aStar({ root: d, goal: a, directed: true, weight, heuristic: nullH });
