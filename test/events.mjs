...
describe('gpu/events', function () {
  ...
  describe('predicate-qualified core listeners (delegation)', function () {
    ...
    it('restricts to matching targets', function () {
      ...
      cy.on('add', isNode, function () {
        nodeAdds++;
      });
      cy.on('add', isEdge, function () {
        edgeAdds++;
      });
