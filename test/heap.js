...
describe('Heap', function () {
    ...
    var checkInternalDataLength = function(heap) {
        return heap._p.length === heap._p.heap.length && heap._p.length === heap._p.elements.length && heap._p.length === Object.keys(heap._p.pointers).length;
    };
  ...
  beforeEach(function(done){
    ...
    it('heap getting top elements', function () {
        var prev = minh3.pop();
        expect(minh3.isHeap()).to.be.true;
