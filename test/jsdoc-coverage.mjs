...
import { audit, PUBLIC_API } from '../scripts/jsdoc-coverage.mjs';
...
describe('gpu/docs: JSDoc coverage of the v4 surface (round 26)', function () {
  ...
  */
  ...
  /*
  Round 37.3.  `src/index.mts` has been listed in PUBLIC_API since round
  26 and contributed **nothing** to any of these audits until now: its whole
  surface is `export default function cytoscape`, and the exported-function
