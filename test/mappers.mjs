...
describe('gpu/mappers', function(){
  ...
  describe('stylesheet integration', function(){
    const graph = ( style, elements ) => cytoscape( {
      elements: elements ?? [
        { data: { id: 'a', w: 0 } },
        { data: { id: 'b', w: 5 } },
        { data: { id: 'c', w: 10 } },
    ...
    it('round-trips mapper sheets through json()', function(){
      ...
      const cy2 = cytoscape( { elements: [ { data: { id: 'x', w: 5 } } ], style: cy.json().style } );
    ...
    it('round-trips case sheets through json()', function(){
      ...
      const cy = cytoscape( { elements: [ { data: { id: 'a', t: 'box' } } ], style: sheet } );
