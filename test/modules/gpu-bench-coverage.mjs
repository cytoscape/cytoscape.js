import { audit, mentions } from '../../scripts/gpu-bench-coverage.mjs';
import { expect } from 'chai';

// Round 33.12.  The precedent is test/modules/gpu-throw-coverage.mjs: a
...
describe( 'gpu benchmark coverage audit', function(){
  ...
  describe( 'audit()', function(){
    it( 'reports per public-API file, counting callable members only', function(){
      ...
      const core = perFile.find( f => f.file === 'src/gpu/core.mts' );
    ...
    it( 'names an uncovered member with its file and line', function(){
      ...
      expect( withGaps[ 0 ].uncovered[ 0 ] ).to.match( /src\/gpu\/[\w./-]+:\d+/ );
    } );
  } );
