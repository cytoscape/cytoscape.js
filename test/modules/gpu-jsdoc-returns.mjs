import { auditReturnTags } from '../../scripts/gpu-jsdoc-coverage.mjs';
import { expect } from 'chai';
import { mkdtempSync, rmSync, writeFileSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';

// Round 36.1.  The precedent is test/modules/gpu-throw-coverage.mjs and
// test/modules/gpu-bench-coverage.mjs: a tool's own parser gets a fixture
  ...
  describe( 'against the real sources', function(){
    ...
    it( 'finds a non-trivial number of tagged members', function(){
      ...
      const r = auditReturnTags(
        new URL( '../../src/gpu/collection.mts', import.meta.url ).pathname
      );
