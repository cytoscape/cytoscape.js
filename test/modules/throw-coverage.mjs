import { audit, BROWSER_ONLY, gateFailures, MISATTRIBUTED, UNREACHABLE } from '../../scripts/throw-coverage.mjs';
...
const EMPTY_EXPORT_GUARD = throwLine(
  'src/render/renderer.mts', 'Cannot export a full-graph image'
);
...
describe('scripts/throw-coverage', function(){
  ...
  it('counts only Node-reachable sites as dead', function(){
    ...
    expect( isDead( 'src/render/renderer.mts', EMPTY_EXPORT_GUARD ) ).to.equal( false ); // browser
