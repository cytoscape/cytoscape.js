...
describe('gpu/core: serialize + padding accessors', function () {
  ...
  beforeEach(function () {
    cy = cytoscape({
      elements: [
        {
          data: { id: 'a', weight: 1.5, kind: 'x', misc: { deep: true } },
          position: { x: 10, y: 20 },
        },
  ...
  it('round-trips ids, positions and data through the wire', function () {
    ...
    var cy2 = cytoscape({ elements: buf });
  ...
  it('round-trips selection state', function () {
    ...
    var cy2 = cytoscape({ elements: cy.serialize() });
  ...
  it('serializes an empty graph', function () {
    var cy2 = cytoscape({});
    var cy3 = cytoscape({ elements: cy2.serialize() });
