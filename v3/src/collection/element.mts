...
import type { CoreAccess, Element as ElementType, ElementDefinition, ElementPrivate, ElementStatic } from './eles-types.mjs';

// represents a node or an edge
let Element = function( this: ElementType, cy: CoreAccess, params: ElementDefinition, restore = true ){
  ...
  let _p: ElementPrivate = this._private = ({
    cy: cy,
    ...
    classes: new Set<string>(), // map ( className => true )
  ...
  }) as unknown as ElementPrivate; // `map` is added by restore(), called below
