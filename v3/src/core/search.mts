...
import type { Collection as Coll, Element, ElementDefinition, CoreAccess, NodeCollection, EdgeCollection, SharedCollection } from '../collection/eles-types.mjs';
...
let corefn = ({
  ...
  collection: function( this: Core, eles?: string | SharedCollection | SharedCollection[] | ElementDefinition[], opts?: CollectionOpts ){
...
export interface CoreSearch {
  collection( this: Core, eles?: string | SharedCollection | SharedCollection[] | ElementDefinition[], opts?: CollectionOpts ): Coll;
